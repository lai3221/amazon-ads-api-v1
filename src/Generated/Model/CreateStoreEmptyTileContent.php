...
/**
 * Represents the CreateStoreEmptyTileContent schema from Amazon Ads API v1.
 *
 * @generated from Amazon Ads API v1 schema CreateStoreEmptyTileContent.
 */
final class CreateStoreEmptyTileContent extends AbstractModel
{
    /**
     * The exact component schema name from the Amazon OpenAPI document.
     */
    public const OPENAPI_NAME = 'CreateStoreEmptyTileContent';
