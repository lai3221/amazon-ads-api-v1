...
/**
 * Represents the StoreTilePosition schema from Amazon Ads API v1.
 *
 * @generated from Amazon Ads API v1 schema StoreTilePosition.
 */
final class StoreTilePosition extends AbstractModel
{
    /**
     * The exact component schema name from the Amazon OpenAPI document.
     */
    public const OPENAPI_NAME = 'StoreTilePosition';
