 ...
 *
 * @generated from Amazon Ads API v1 schema CreateBrandStoreCallToActionSettings.
 */
final class CreateBrandStoreCallToActionSettings extends AbstractModel
{
    /**
     * The exact component schema name from the Amazon OpenAPI document.
     */
    public const OPENAPI_NAME = 'CreateBrandStoreCallToActionSettings';
    ...
    protected const ATTRIBUTE_DEFINITIONS = [
        'callToActionType' => [
            ...
            'items' => [
                'type' => 'enum',
                'class' => BrandStoreCallToActionType::class,
            ],
            'required' => false,
            'nullable' => false,
            'minItems' => 0,
    ...
    /**
     * Returns Type of CallToAction for BrandStore..
     *
     * @return list<BrandStoreCallToActionType>|null
     */
    public function getCallToActionType(): ?array
    {
        /** @var list<BrandStoreCallToActionType>|null $value */
    ...
    /**
     * Sets Type of CallToAction for BrandStore..
     *
     * @param list<BrandStoreCallToActionType>|null $value New property value.
     * @return $this
     */
