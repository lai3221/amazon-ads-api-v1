...
/**
 * Represents the CreateAdvertisedProducts schema from Amazon Ads API v1.
 *
 * @generated from Amazon Ads API v1 schema CreateAdvertisedProducts.
 */
final class CreateAdvertisedProducts extends AbstractModel
{
    /**
     * The exact component schema name from the Amazon OpenAPI document.
     */
    public const OPENAPI_NAME = 'CreateAdvertisedProducts';
