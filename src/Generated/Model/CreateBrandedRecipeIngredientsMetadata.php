 ...
 *
 * @generated from Amazon Ads API v1 schema CreateBrandedRecipeIngredientsMetadata.
 */
final class CreateBrandedRecipeIngredientsMetadata extends AbstractModel
{
    /**
     * The exact component schema name from the Amazon OpenAPI document.
     */
    public const OPENAPI_NAME = 'CreateBrandedRecipeIngredientsMetadata';
    ...
    protected const ATTRIBUTE_DEFINITIONS = [
        'priorityAsins' => [
            ...
            'items' => [
                'type' => 'model',
                'class' => CreatePriorityAsin::class,
            ],
            'required' => false,
            'nullable' => false,
            'minItems' => 0,
     ...
     *
     * @return list<CreatePriorityAsin>|null
     */
    public function getPriorityAsins(): ?array
    {
        /** @var list<CreatePriorityAsin>|null $value */
     ...
     *
     * @param list<CreatePriorityAsin>|null $value New property value.
     * @return $this
     */
