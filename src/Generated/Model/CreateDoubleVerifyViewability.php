...
/**
 * Represents the CreateDoubleVerifyViewability schema from Amazon Ads API v1.
 *
 * @generated from Amazon Ads API v1 schema CreateDoubleVerifyViewability.
 */
final class CreateDoubleVerifyViewability extends AbstractModel
{
    /**
     * The exact component schema name from the Amazon OpenAPI document.
     */
    public const OPENAPI_NAME = 'CreateDoubleVerifyViewability';
