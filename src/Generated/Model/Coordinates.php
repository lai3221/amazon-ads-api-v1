...
/**
 * Represents the Coordinates schema from Amazon Ads API v1.
 *
 * @generated from Amazon Ads API v1 schema Coordinates.
 */
final class Coordinates extends AbstractModel
{
    /**
     * The exact component schema name from the Amazon OpenAPI document.
     */
    public const OPENAPI_NAME = 'Coordinates';
