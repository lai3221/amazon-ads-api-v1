...
/**
 * Represents the CreateDspContentRating schema from Amazon Ads API v1.
 *
 * @generated from Amazon Ads API v1 schema CreateDspContentRating.
 */
final class CreateDspContentRating extends AbstractModel
{
    /**
     * The exact component schema name from the Amazon OpenAPI document.
     */
    public const OPENAPI_NAME = 'CreateDspContentRating';
