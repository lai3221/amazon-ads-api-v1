...
/**
 * Represents the AdGroupAdProductFilter schema from Amazon Ads API v1.
 *
 * @generated from Amazon Ads API v1 schema AdGroupAdProductFilter.
 */
final class AdGroupAdProductFilter extends AbstractModel
{
    /**
     * The exact component schema name from the Amazon OpenAPI document.
     */
    public const OPENAPI_NAME = 'AdGroupAdProductFilter';
