...
/**
 * Represents the CreateDoubleVerifyFraudInvalidTraffic schema from Amazon Ads API v1.
 *
 * @generated from Amazon Ads API v1 schema CreateDoubleVerifyFraudInvalidTraffic.
 */
final class CreateDoubleVerifyFraudInvalidTraffic extends AbstractModel
{
    /**
     * The exact component schema name from the Amazon OpenAPI document.
     */
    public const OPENAPI_NAME = 'CreateDoubleVerifyFraudInvalidTraffic';
