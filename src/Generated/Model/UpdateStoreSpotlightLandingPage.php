...
/**
 * Represents the UpdateStoreSpotlightLandingPage schema from Amazon Ads API v1.
 *
 * @generated from Amazon Ads API v1 schema UpdateStoreSpotlightLandingPage.
 */
final class UpdateStoreSpotlightLandingPage extends AbstractModel
{
    /**
     * The exact component schema name from the Amazon OpenAPI document.
     */
    public const OPENAPI_NAME = 'UpdateStoreSpotlightLandingPage';
