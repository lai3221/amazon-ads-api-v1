...
/**
 * Represents the UpdateAdvertisingDealPrice schema from Amazon Ads API v1.
 *
 * @generated from Amazon Ads API v1 schema UpdateAdvertisingDealPrice.
 */
final class UpdateAdvertisingDealPrice extends AbstractModel
{
    /**
     * The exact component schema name from the Amazon OpenAPI document.
     */
    public const OPENAPI_NAME = 'UpdateAdvertisingDealPrice';
