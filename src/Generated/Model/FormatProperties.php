...
/**
 * Represents the FormatProperties schema from Amazon Ads API v1.
 *
 * @generated from Amazon Ads API v1 schema FormatProperties.
 */
final class FormatProperties extends AbstractModel
{
    /**
     * The exact component schema name from the Amazon OpenAPI document.
     */
    public const OPENAPI_NAME = 'FormatProperties';
