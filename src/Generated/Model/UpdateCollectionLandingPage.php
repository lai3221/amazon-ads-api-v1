...
/**
 * Represents the UpdateCollectionLandingPage schema from Amazon Ads API v1.
 *
 * @generated from Amazon Ads API v1 schema UpdateCollectionLandingPage.
 */
final class UpdateCollectionLandingPage extends AbstractModel
{
    /**
     * The exact component schema name from the Amazon OpenAPI document.
     */
    public const OPENAPI_NAME = 'UpdateCollectionLandingPage';
