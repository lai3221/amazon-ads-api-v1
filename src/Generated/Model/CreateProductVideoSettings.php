 ...
 *
 * @generated from Amazon Ads API v1 schema CreateProductVideoSettings.
 */
final class CreateProductVideoSettings extends AbstractModel
{
    /**
     * The exact component schema name from the Amazon OpenAPI document.
     */
    public const OPENAPI_NAME = 'CreateProductVideoSettings';
