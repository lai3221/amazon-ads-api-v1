...
/**
 * Represents the StoreLiveVideoContent schema from Amazon Ads API v1.
 *
 * @generated from Amazon Ads API v1 schema StoreLiveVideoContent.
 */
final class StoreLiveVideoContent extends AbstractModel
{
    /**
     * The exact component schema name from the Amazon OpenAPI document.
     */
    public const OPENAPI_NAME = 'StoreLiveVideoContent';
