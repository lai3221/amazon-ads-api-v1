...
/**
 * Represents the CreateStoreMobileImageWithTextContent schema from Amazon Ads API v1.
 *
 * @generated from Amazon Ads API v1 schema CreateStoreMobileImageWithTextContent.
 */
final class CreateStoreMobileImageWithTextContent extends AbstractModel
{
    /**
     * The exact component schema name from the Amazon OpenAPI document.
     */
    public const OPENAPI_NAME = 'CreateStoreMobileImageWithTextContent';
    ...
    /**
     * Returns Whether to render tile layers on mobile..
     *
     * @return bool|null
     */
    ...
    /**
     * Sets Whether to render tile layers on mobile..
     *
     * @param bool|null $value New property value.
     * @return $this
     */
     ...
     *
     * @return StoreImageShape|null
     */
    public function getShape(): ?StoreImageShape
    {
        /** @var StoreImageShape|null $value */
        $value = $this->getAttribute('shape');
     ...
     *
     * @param StoreImageShape|string|null $value New property value.
     * @return $this
     */
    public function setShape(StoreImageShape|string|null $value): self
    {
    ...
    /**
     * Returns Text content for mobile..
     *
     * @return string|null
     */
     ...
     *
     * @return StoreTextOption|null
     */
    public function getTextOption(): ?StoreTextOption
    {
        /** @var StoreTextOption|null $value */
     ...
     *
     * @param StoreTextOption|string|null $value New property value.
     * @return $this
     */
    public function setTextOption(StoreTextOption|string|null $value): self
    {
