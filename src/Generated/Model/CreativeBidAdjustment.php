...
/**
 * Represents the CreativeBidAdjustment schema from Amazon Ads API v1.
 *
 * @generated from Amazon Ads API v1 schema CreativeBidAdjustment.
 */
final class CreativeBidAdjustment extends AbstractModel
{
    /**
     * The exact component schema name from the Amazon OpenAPI document.
     */
    public const OPENAPI_NAME = 'CreativeBidAdjustment';
