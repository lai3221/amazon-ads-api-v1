...
/**
 * Represents the CreateRuleLinkIdentity schema from Amazon Ads API v1.
 *
 * @generated from Amazon Ads API v1 schema CreateRuleLinkIdentity.
 */
final class CreateRuleLinkIdentity extends AbstractModel
{
    /**
     * The exact component schema name from the Amazon OpenAPI document.
     */
    public const OPENAPI_NAME = 'CreateRuleLinkIdentity';
