 ...
 *
 * @generated from Amazon Ads API v1 schema CreateAccountToCombine.
 */
final class CreateAccountToCombine extends AbstractModel
{
    /**
     * The exact component schema name from the Amazon OpenAPI document.
     */
    public const OPENAPI_NAME = 'CreateAccountToCombine';
