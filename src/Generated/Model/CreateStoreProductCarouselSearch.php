...
/**
 * Represents the CreateStoreProductCarouselSearch schema from Amazon Ads API v1.
 *
 * @generated from Amazon Ads API v1 schema CreateStoreProductCarouselSearch.
 */
final class CreateStoreProductCarouselSearch extends AbstractModel
{
    /**
     * The exact component schema name from the Amazon OpenAPI document.
     */
    public const OPENAPI_NAME = 'CreateStoreProductCarouselSearch';
