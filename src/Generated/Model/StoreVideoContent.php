...
/**
 * Represents the StoreVideoContent schema from Amazon Ads API v1.
 *
 * @generated from Amazon Ads API v1 schema StoreVideoContent.
 */
final class StoreVideoContent extends AbstractModel
{
    /**
     * The exact component schema name from the Amazon OpenAPI document.
     */
    public const OPENAPI_NAME = 'StoreVideoContent';
