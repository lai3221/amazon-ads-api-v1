...
/**
 * Represents the TimeOfDay schema from Amazon Ads API v1.
 *
 * @generated from Amazon Ads API v1 schema TimeOfDay.
 */
final class TimeOfDay extends AbstractModel
{
    /**
     * The exact component schema name from the Amazon OpenAPI document.
     */
    public const OPENAPI_NAME = 'TimeOfDay';
