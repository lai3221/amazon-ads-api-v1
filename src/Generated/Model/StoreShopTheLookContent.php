...
/**
 * Represents the StoreShopTheLookContent schema from Amazon Ads API v1.
 *
 * @generated from Amazon Ads API v1 schema StoreShopTheLookContent.
 */
final class StoreShopTheLookContent extends AbstractModel
{
    /**
     * The exact component schema name from the Amazon OpenAPI document.
     */
    public const OPENAPI_NAME = 'StoreShopTheLookContent';
    ...
    protected const ATTRIBUTE_DEFINITIONS = [
        ...
        'callToActionData' => [
            'type' => 'model',
            'class' => StoreCallToActionData::class,
            'required' => false,
            'nullable' => false,
        ],
        'includeOutOfStock' => [
        ...
        'search' => [
            'type' => 'model',
            'class' => StoreShopTheLookSearch::class,
            'required' => false,
            'nullable' => false,
        ],
        'slides' => [
            ...
            'items' => [
                'type' => 'model',
                'class' => StoreShopTheLookSlide::class,
            ],
            'required' => false,
            'nullable' => false,
            'minItems' => 0,
     ...
     *
     * @return StoreCallToActionData|null
     */
    public function getCallToActionData(): ?StoreCallToActionData
    {
        /** @var StoreCallToActionData|null $value */
     ...
     *
     * @param StoreCallToActionData|array<string, mixed>|null $value New property value.
     * @return $this
     */
    public function setCallToActionData(StoreCallToActionData|array|null $value): self
    {
     ...
     *
     * @return StoreShopTheLookSearch|null
     */
    public function getSearch(): ?StoreShopTheLookSearch
    {
        /** @var StoreShopTheLookSearch|null $value */
     ...
     *
     * @param StoreShopTheLookSearch|array<string, mixed>|null $value New property value.
     * @return $this
     */
    public function setSearch(StoreShopTheLookSearch|array|null $value): self
    {
     ...
     *
     * @return list<StoreShopTheLookSlide>|null
     */
    public function getSlides(): ?array
    {
        /** @var list<StoreShopTheLookSlide>|null $value */
     ...
     *
     * @param list<StoreShopTheLookSlide>|null $value New property value.
     * @return $this
     */
