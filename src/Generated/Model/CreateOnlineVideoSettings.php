...
/**
 * Represents the CreateOnlineVideoSettings schema from Amazon Ads API v1.
 *
 * @generated from Amazon Ads API v1 schema CreateOnlineVideoSettings.
 */
final class CreateOnlineVideoSettings extends AbstractModel
{
    /**
     * The exact component schema name from the Amazon OpenAPI document.
     */
    public const OPENAPI_NAME = 'CreateOnlineVideoSettings';
