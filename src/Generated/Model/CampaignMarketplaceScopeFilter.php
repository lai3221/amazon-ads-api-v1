...
/**
 * Represents the CampaignMarketplaceScopeFilter schema from Amazon Ads API v1.
 *
 * @generated from Amazon Ads API v1 schema CampaignMarketplaceScopeFilter.
 */
final class CampaignMarketplaceScopeFilter extends AbstractModel
{
    /**
     * The exact component schema name from the Amazon OpenAPI document.
     */
    public const OPENAPI_NAME = 'CampaignMarketplaceScopeFilter';
