...
/**
 * Represents the Image schema from Amazon Ads API v1.
 *
 * @generated from Amazon Ads API v1 schema Image.
 */
final class Image extends AbstractModel
{
     ...
     */
    public const OPENAPI_NAME = 'Image';
     ...
     *
     * @return list<FormatProperties>|null
     */
    public function getFormatProperties(): ?array
    {
        /** @var list<FormatProperties>|null $value */
     ...
     *
     * @param list<FormatProperties>|null $value New property value.
     * @return $this
     */
