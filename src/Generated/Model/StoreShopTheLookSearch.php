...
/**
 * Represents the StoreShopTheLookSearch schema from Amazon Ads API v1.
 *
 * @generated from Amazon Ads API v1 schema StoreShopTheLookSearch.
 */
final class StoreShopTheLookSearch extends AbstractModel
{
    /**
     * The exact component schema name from the Amazon OpenAPI document.
     */
    public const OPENAPI_NAME = 'StoreShopTheLookSearch';
