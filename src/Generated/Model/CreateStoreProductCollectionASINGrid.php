...
/**
 * Represents the CreateStoreProductCollectionASINGrid schema from Amazon Ads API v1.
 *
 * @generated from Amazon Ads API v1 schema CreateStoreProductCollectionASINGrid.
 */
final class CreateStoreProductCollectionASINGrid extends AbstractModel
{
    /**
     * The exact component schema name from the Amazon OpenAPI document.
     */
    public const OPENAPI_NAME = 'CreateStoreProductCollectionASINGrid';
