 ...
 *
 * @generated from Amazon Ads API v1 schema LinearTvInventoryAllocation.
 */
final class LinearTvInventoryAllocation extends AbstractModel
{
    /**
     * The exact component schema name from the Amazon OpenAPI document.
     */
    public const OPENAPI_NAME = 'LinearTvInventoryAllocation';
