...
/**
 * Represents the MarketplaceCampaignFieldOverrides schema from Amazon Ads API v1.
 *
 * @generated from Amazon Ads API v1 schema MarketplaceCampaignFieldOverrides.
 */
final class MarketplaceCampaignFieldOverrides extends AbstractModel
{
    /**
     * The exact component schema name from the Amazon OpenAPI document.
     */
    public const OPENAPI_NAME = 'MarketplaceCampaignFieldOverrides';
