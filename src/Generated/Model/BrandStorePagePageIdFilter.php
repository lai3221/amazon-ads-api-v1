...
/**
 * Represents the BrandStorePagePageIdFilter schema from Amazon Ads API v1.
 *
 * @generated from Amazon Ads API v1 schema BrandStorePagePageIdFilter.
 */
final class BrandStorePagePageIdFilter extends AbstractModel
{
    /**
     * The exact component schema name from the Amazon OpenAPI document.
     */
    public const OPENAPI_NAME = 'BrandStorePagePageIdFilter';
