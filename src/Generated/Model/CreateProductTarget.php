 ...
 *
 * @generated from Amazon Ads API v1 schema CreateProductTarget.
 */
final class CreateProductTarget extends AbstractModel
{
    /**
     * The exact component schema name from the Amazon OpenAPI document.
     */
    public const OPENAPI_NAME = 'CreateProductTarget';
    ...
    protected const ATTRIBUTE_DEFINITIONS = [
        ...
        'product' => [
            'type' => 'model',
            'class' => CreateProductValue::class,
            'required' => true,
            'nullable' => false,
        ],
        'productIdType' => [
     ...
     *
     * @return CreateProductValue|null
     */
    public function getProduct(): ?CreateProductValue
    {
        /** @var CreateProductValue|null $value */
     ...
     *
     * @param CreateProductValue|array<string, mixed>|null $value New property value.
     * @return $this
     */
    public function setProduct(CreateProductValue|array|null $value): self
    {
