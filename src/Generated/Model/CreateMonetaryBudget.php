...
/**
 * Represents the CreateMonetaryBudget schema from Amazon Ads API v1.
 *
 * @generated from Amazon Ads API v1 schema CreateMonetaryBudget.
 */
final class CreateMonetaryBudget extends AbstractModel
{
    /**
     * The exact component schema name from the Amazon OpenAPI document.
     */
    public const OPENAPI_NAME = 'CreateMonetaryBudget';
