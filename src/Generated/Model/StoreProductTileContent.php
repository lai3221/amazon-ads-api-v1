...
/**
 * Represents the StoreProductTileContent schema from Amazon Ads API v1.
 *
 * @generated from Amazon Ads API v1 schema StoreProductTileContent.
 */
final class StoreProductTileContent extends AbstractModel
{
    /**
     * The exact component schema name from the Amazon OpenAPI document.
     */
    public const OPENAPI_NAME = 'StoreProductTileContent';
