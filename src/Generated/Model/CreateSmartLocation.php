 ...
 *
 * @generated from Amazon Ads API v1 schema CreateSmartLocation.
 */
final class CreateSmartLocation extends AbstractModel
{
    /**
     * The exact component schema name from the Amazon OpenAPI document.
     */
    public const OPENAPI_NAME = 'CreateSmartLocation';
