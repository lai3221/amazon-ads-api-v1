...
/**
 * Represents the CreateDoubleVerifyBrandSafety schema from Amazon Ads API v1.
 *
 * @generated from Amazon Ads API v1 schema CreateDoubleVerifyBrandSafety.
 */
final class CreateDoubleVerifyBrandSafety extends AbstractModel
{
    /**
     * The exact component schema name from the Amazon OpenAPI document.
     */
    public const OPENAPI_NAME = 'CreateDoubleVerifyBrandSafety';
