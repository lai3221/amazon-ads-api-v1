...
/**
 * Represents the DeleteRuleRequest schema from Amazon Ads API v1.
 *
 * @generated from Amazon Ads API v1 schema DeleteRuleRequest.
 */
final class DeleteRuleRequest extends AbstractModel
{
    /**
     * The exact component schema name from the Amazon OpenAPI document.
     */
    public const OPENAPI_NAME = 'DeleteRuleRequest';
