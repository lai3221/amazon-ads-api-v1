 ...
 *
 * @generated from Amazon Ads API v1 schema UpdateProductCollectionSettings.
 */
final class UpdateProductCollectionSettings extends AbstractModel
{
    /**
     * The exact component schema name from the Amazon OpenAPI document.
     */
    public const OPENAPI_NAME = 'UpdateProductCollectionSettings';
    ...
    protected const ATTRIBUTE_DEFINITIONS = [
        ...
        'landingPage' => [
            'type' => 'model',
            'class' => UpdateProductCollectionLandingPage::class,
            'required' => false,
            'nullable' => false,
        ],
        'products' => [
     ...
     *
     * @return UpdateProductCollectionLandingPage|null
     */
    public function getLandingPage(): ?UpdateProductCollectionLandingPage
    {
        /** @var UpdateProductCollectionLandingPage|null $value */
     ...
     *
     * @param UpdateProductCollectionLandingPage|array<string, mixed>|null $value New property value.
     * @return $this
     */
    public function setLandingPage(UpdateProductCollectionLandingPage|array|null $value): self
    {
