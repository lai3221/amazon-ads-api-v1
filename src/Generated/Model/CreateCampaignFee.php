...
/**
 * Represents the CreateCampaignFee schema from Amazon Ads API v1.
 *
 * @generated from Amazon Ads API v1 schema CreateCampaignFee.
 */
final class CreateCampaignFee extends AbstractModel
{
    /**
     * The exact component schema name from the Amazon OpenAPI document.
     */
    public const OPENAPI_NAME = 'CreateCampaignFee';
