...
/**
 * Represents the AdAssociationAdIdFilter schema from Amazon Ads API v1.
 *
 * @generated from Amazon Ads API v1 schema AdAssociationAdIdFilter.
 */
final class AdAssociationAdIdFilter extends AbstractModel
{
    /**
     * The exact component schema name from the Amazon OpenAPI document.
     */
    public const OPENAPI_NAME = 'AdAssociationAdIdFilter';
