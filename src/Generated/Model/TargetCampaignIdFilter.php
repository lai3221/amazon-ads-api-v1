...
/**
 * Represents the TargetCampaignIdFilter schema from Amazon Ads API v1.
 *
 * @generated from Amazon Ads API v1 schema TargetCampaignIdFilter.
 */
final class TargetCampaignIdFilter extends AbstractModel
{
    /**
     * The exact component schema name from the Amazon OpenAPI document.
     */
    public const OPENAPI_NAME = 'TargetCampaignIdFilter';
