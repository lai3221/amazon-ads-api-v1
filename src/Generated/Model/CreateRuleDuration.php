 ...
 *
 * @generated from Amazon Ads API v1 schema CreateRuleDuration.
 */
final class CreateRuleDuration extends AbstractModel
{
    /**
     * The exact component schema name from the Amazon OpenAPI document.
     */
    public const OPENAPI_NAME = 'CreateRuleDuration';
