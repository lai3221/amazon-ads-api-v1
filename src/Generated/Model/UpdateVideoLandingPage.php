...
/**
 * Represents the UpdateVideoLandingPage schema from Amazon Ads API v1.
 *
 * @generated from Amazon Ads API v1 schema UpdateVideoLandingPage.
 */
final class UpdateVideoLandingPage extends AbstractModel
{
    /**
     * The exact component schema name from the Amazon OpenAPI document.
     */
    public const OPENAPI_NAME = 'UpdateVideoLandingPage';
