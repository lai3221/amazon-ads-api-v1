...
/**
 * Represents the CreateStoreCarouselSearch schema from Amazon Ads API v1.
 *
 * @generated from Amazon Ads API v1 schema CreateStoreCarouselSearch.
 */
final class CreateStoreCarouselSearch extends AbstractModel
{
    /**
     * The exact component schema name from the Amazon OpenAPI document.
     */
    public const OPENAPI_NAME = 'CreateStoreCarouselSearch';
