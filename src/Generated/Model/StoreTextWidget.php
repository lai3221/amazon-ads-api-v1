...
/**
 * Represents the StoreTextWidget schema from Amazon Ads API v1.
 *
 * @generated from Amazon Ads API v1 schema StoreTextWidget.
 */
final class StoreTextWidget extends AbstractModel
{
    /**
     * The exact component schema name from the Amazon OpenAPI document.
     */
    public const OPENAPI_NAME = 'StoreTextWidget';
     ...
     *
     * @return list<StoreTextTile>|null
     */
    public function getTiles(): ?array
    {
        /** @var list<StoreTextTile>|null $value */
     ...
     *
     * @param list<StoreTextTile>|null $value New property value.
     * @return $this
     */
