...
/**
 * Represents the BrandStoreStoreNameFilter schema from Amazon Ads API v1.
 *
 * @generated from Amazon Ads API v1 schema BrandStoreStoreNameFilter.
 */
final class BrandStoreStoreNameFilter extends AbstractModel
{
    /**
     * The exact component schema name from the Amazon OpenAPI document.
     */
    public const OPENAPI_NAME = 'BrandStoreStoreNameFilter';
