...
/**
 * Represents the CreateStoreCropBoxData schema from Amazon Ads API v1.
 *
 * @generated from Amazon Ads API v1 schema CreateStoreCropBoxData.
 */
final class CreateStoreCropBoxData extends AbstractModel
{
    /**
     * The exact component schema name from the Amazon OpenAPI document.
     */
    public const OPENAPI_NAME = 'CreateStoreCropBoxData';
