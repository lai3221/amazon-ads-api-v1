...
/**
 * Represents the CampaignAdProductFilter schema from Amazon Ads API v1.
 *
 * @generated from Amazon Ads API v1 schema CampaignAdProductFilter.
 */
final class CampaignAdProductFilter extends AbstractModel
{
    /**
     * The exact component schema name from the Amazon OpenAPI document.
     */
    public const OPENAPI_NAME = 'CampaignAdProductFilter';
