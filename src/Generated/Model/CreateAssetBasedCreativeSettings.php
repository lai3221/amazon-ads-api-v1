...
/**
 * Represents the CreateAssetBasedCreativeSettings schema from Amazon Ads API v1.
 *
 * @generated from Amazon Ads API v1 schema CreateAssetBasedCreativeSettings.
 */
final class CreateAssetBasedCreativeSettings extends AbstractModel
{
    /**
     * The exact component schema name from the Amazon OpenAPI document.
     */
    public const OPENAPI_NAME = 'CreateAssetBasedCreativeSettings';
    ...
    protected const ATTRIBUTE_DEFINITIONS = [
        ...
        'callToActions' => [
            'type' => 'model',
            'class' => CreateAssetBasedCreativeCallToAction::class,
            'required' => false,
            'nullable' => false,
        ],
        'clickTrackingUrls' => [
        ...
        'landingPage' => [
            'type' => 'model',
            'class' => CreateComponentLandingPage::class,
            'required' => false,
            'nullable' => false,
        ],
        'language' => [
     ...
     *
     * @return CreateAssetBasedCreativeCallToAction|null
     */
    public function getCallToActions(): ?CreateAssetBasedCreativeCallToAction
    {
        /** @var CreateAssetBasedCreativeCallToAction|null $value */
     ...
     *
     * @param CreateAssetBasedCreativeCallToAction|array<string, mixed>|null $value New property value.
     * @return $this
     */
    public function setCallToActions(CreateAssetBasedCreativeCallToAction|array|null $value): self
    {
     ...
     */
    public function getCustomVideos(): ?CreateVideo
    {
     ...
     * @return $this
     */
    public function setCustomVideos(CreateVideo|array|null $value): self
    {
     ...
     *
     * @return CreateComponentLandingPage|null
     */
    public function getLandingPage(): ?CreateComponentLandingPage
    {
        /** @var CreateComponentLandingPage|null $value */
     ...
     *
     * @param CreateComponentLandingPage|array<string, mixed>|null $value New property value.
     * @return $this
     */
    public function setLandingPage(CreateComponentLandingPage|array|null $value): self
    {
