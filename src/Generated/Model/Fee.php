...
/**
 * Represents the Fee schema from Amazon Ads API v1.
 *
 * @generated from Amazon Ads API v1 schema Fee.
 */
final class Fee extends AbstractModel
{
    /**
     * The exact component schema name from the Amazon OpenAPI document.
     */
    public const OPENAPI_NAME = 'Fee';
     ...
     *
     * @return FeeValueType|null
     */
    public function getFeeValueType(): ?FeeValueType
    {
        /** @var FeeValueType|null $value */
     ...
     *
     * @param FeeValueType|string|null $value New property value.
     * @return $this
     */
    public function setFeeValueType(FeeValueType|string|null $value): self
    {
