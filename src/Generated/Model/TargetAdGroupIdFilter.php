...
/**
 * Represents the TargetAdGroupIdFilter schema from Amazon Ads API v1.
 *
 * @generated from Amazon Ads API v1 schema TargetAdGroupIdFilter.
 */
final class TargetAdGroupIdFilter extends AbstractModel
{
    /**
     * The exact component schema name from the Amazon OpenAPI document.
     */
    public const OPENAPI_NAME = 'TargetAdGroupIdFilter';
