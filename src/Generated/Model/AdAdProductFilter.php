...
/**
 * Represents the AdAdProductFilter schema from Amazon Ads API v1.
 *
 * @generated from Amazon Ads API v1 schema AdAdProductFilter.
 */
final class AdAdProductFilter extends AbstractModel
{
    /**
     * The exact component schema name from the Amazon OpenAPI document.
     */
    public const OPENAPI_NAME = 'AdAdProductFilter';
