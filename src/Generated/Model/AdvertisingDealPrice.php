...
/**
 * Represents the AdvertisingDealPrice schema from Amazon Ads API v1.
 *
 * @generated from Amazon Ads API v1 schema AdvertisingDealPrice.
 */
final class AdvertisingDealPrice extends AbstractModel
{
    /**
     * The exact component schema name from the Amazon OpenAPI document.
     */
    public const OPENAPI_NAME = 'AdvertisingDealPrice';
