...
/**
 * Represents the CreateCommonTileProperties schema from Amazon Ads API v1.
 *
 * @generated from Amazon Ads API v1 schema CreateCommonTileProperties.
 */
final class CreateCommonTileProperties extends AbstractModel
{
    /**
     * The exact component schema name from the Amazon OpenAPI document.
     */
    public const OPENAPI_NAME = 'CreateCommonTileProperties';
