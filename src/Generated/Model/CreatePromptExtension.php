 ...
 *
 * @generated from Amazon Ads API v1 schema CreatePromptExtension.
 */
final class CreatePromptExtension extends AbstractModel
{
    /**
     * The exact component schema name from the Amazon OpenAPI document.
     */
    public const OPENAPI_NAME = 'CreatePromptExtension';
