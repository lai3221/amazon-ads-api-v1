 ...
 *
 * @generated from Amazon Ads API v1 schema Consent.
 */
final class Consent extends AbstractModel
{
    /**
     * The exact component schema name from the Amazon OpenAPI document.
     */
    public const OPENAPI_NAME = 'Consent';
    ...
    protected const ATTRIBUTE_DEFINITIONS = [
        'amazonConsent' => [
            'type' => 'model',
            'class' => AmazonConsentFormat::class,
            'required' => false,
            'nullable' => false,
        ],
        'geo' => [
            'type' => 'model',
            'class' => GeographicConsentData::class,
            'required' => false,
            'nullable' => false,
        ],
        'gpp' => [
     ...
     *
     * @return AmazonConsentFormat|null
     */
    public function getAmazonConsent(): ?AmazonConsentFormat
    {
        /** @var AmazonConsentFormat|null $value */
     ...
     *
     * @param AmazonConsentFormat|array<string, mixed>|null $value New property value.
     * @return $this
     */
    public function setAmazonConsent(AmazonConsentFormat|array|null $value): self
    {
     ...
     *
     * @return GeographicConsentData|null
     */
    public function getGeo(): ?GeographicConsentData
    {
        /** @var GeographicConsentData|null $value */
     ...
     * Sets the geo value.
     *
     * @param GeographicConsentData|array<string, mixed>|null $value New property value.
     * @return $this
     */
    public function setGeo(GeographicConsentData|array|null $value): self
    {
