...
/**
 * Represents the CreateComparisonPredicate schema from Amazon Ads API v1.
 *
 * @generated from Amazon Ads API v1 schema CreateComparisonPredicate.
 */
final class CreateComparisonPredicate extends AbstractModel
{
    /**
     * The exact component schema name from the Amazon OpenAPI document.
     */
    public const OPENAPI_NAME = 'CreateComparisonPredicate';
