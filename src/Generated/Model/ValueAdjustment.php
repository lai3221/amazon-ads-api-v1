...
/**
 * Represents the ValueAdjustment schema from Amazon Ads API v1.
 *
 * @generated from Amazon Ads API v1 schema ValueAdjustment.
 */
final class ValueAdjustment extends AbstractModel
{
    /**
     * The exact component schema name from the Amazon OpenAPI document.
     */
    public const OPENAPI_NAME = 'ValueAdjustment';
