...
/**
 * Represents the UpdateGoalSettings schema from Amazon Ads API v1.
 *
 * @generated from Amazon Ads API v1 schema UpdateGoalSettings.
 */
final class UpdateGoalSettings extends AbstractModel
{
    /**
     * The exact component schema name from the Amazon OpenAPI document.
     */
    public const OPENAPI_NAME = 'UpdateGoalSettings';
