...
/**
 * Represents the CreateStoreDealsContent schema from Amazon Ads API v1.
 *
 * @generated from Amazon Ads API v1 schema CreateStoreDealsContent.
 */
final class CreateStoreDealsContent extends AbstractModel
{
    /**
     * The exact component schema name from the Amazon OpenAPI document.
     */
    public const OPENAPI_NAME = 'CreateStoreDealsContent';
    ...
    protected const ATTRIBUTE_DEFINITIONS = [
        'deals' => [
            'type' => 'model',
            'class' => CreateStoreDealsConfig::class,
            'required' => false,
            'nullable' => false,
        ],
        'dealsMode' => [
     ...
     *
     * @return CreateStoreDealsConfig|null
     */
    public function getDeals(): ?CreateStoreDealsConfig
    {
        /** @var CreateStoreDealsConfig|null $value */
     ...
     *
     * @param CreateStoreDealsConfig|array<string, mixed>|null $value New property value.
     * @return $this
     */
    public function setDeals(CreateStoreDealsConfig|array|null $value): self
    {
