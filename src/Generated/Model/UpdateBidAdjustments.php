...
/**
 * Represents the UpdateBidAdjustments schema from Amazon Ads API v1.
 *
 * @generated from Amazon Ads API v1 schema UpdateBidAdjustments.
 */
final class UpdateBidAdjustments extends AbstractModel
{
    /**
     * The exact component schema name from the Amazon OpenAPI document.
     */
    public const OPENAPI_NAME = 'UpdateBidAdjustments';
