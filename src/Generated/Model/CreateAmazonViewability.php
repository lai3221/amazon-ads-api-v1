...
/**
 * Represents the CreateAmazonViewability schema from Amazon Ads API v1.
 *
 * @generated from Amazon Ads API v1 schema CreateAmazonViewability.
 */
final class CreateAmazonViewability extends AbstractModel
{
    /**
     * The exact component schema name from the Amazon OpenAPI document.
     */
    public const OPENAPI_NAME = 'CreateAmazonViewability';
