...
/**
 * Represents the UpdateLandingPageAsins schema from Amazon Ads API v1.
 *
 * @generated from Amazon Ads API v1 schema UpdateLandingPageAsins.
 */
final class UpdateLandingPageAsins extends AbstractModel
{
    /**
     * The exact component schema name from the Amazon OpenAPI document.
     */
    public const OPENAPI_NAME = 'UpdateLandingPageAsins';
