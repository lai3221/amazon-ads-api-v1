 ...
 *
 * @generated from Amazon Ads API v1 schema StoreProductSelectorLayoutConfiguration.
 */
final class StoreProductSelectorLayoutConfiguration extends AbstractModel
{
    /**
     * The exact component schema name from the Amazon OpenAPI document.
     */
    public const OPENAPI_NAME = 'StoreProductSelectorLayoutConfiguration';
