...
/**
 * Represents the PromotionRewardMarketplaceFilter schema from Amazon Ads API v1.
 *
 * @generated from Amazon Ads API v1 schema PromotionRewardMarketplaceFilter.
 */
final class PromotionRewardMarketplaceFilter extends AbstractModel
{
    /**
     * The exact component schema name from the Amazon OpenAPI document.
     */
    public const OPENAPI_NAME = 'PromotionRewardMarketplaceFilter';
