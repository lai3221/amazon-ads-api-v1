...
/**
 * Represents the UpdateThirdPartyVideoSettings schema from Amazon Ads API v1.
 *
 * @generated from Amazon Ads API v1 schema UpdateThirdPartyVideoSettings.
 */
final class UpdateThirdPartyVideoSettings extends AbstractModel
{
    /**
     * The exact component schema name from the Amazon OpenAPI document.
     */
    public const OPENAPI_NAME = 'UpdateThirdPartyVideoSettings';
