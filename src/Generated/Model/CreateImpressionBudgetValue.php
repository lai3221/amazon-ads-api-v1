...
/**
 * Represents the CreateImpressionBudgetValue schema from Amazon Ads API v1.
 *
 * @generated from Amazon Ads API v1 schema CreateImpressionBudgetValue.
 */
final class CreateImpressionBudgetValue extends AbstractModel
{
    /**
     * The exact component schema name from the Amazon OpenAPI document.
     */
    public const OPENAPI_NAME = 'CreateImpressionBudgetValue';
