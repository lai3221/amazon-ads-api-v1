 ...
 *
 * @generated from Amazon Ads API v1 schema CreateStoreProductSelectorResults.
 */
final class CreateStoreProductSelectorResults extends AbstractModel
{
    /**
     * The exact component schema name from the Amazon OpenAPI document.
     */
    public const OPENAPI_NAME = 'CreateStoreProductSelectorResults';
