...
/**
 * Represents the CreateBrandStoreSettings schema from Amazon Ads API v1.
 *
 * @generated from Amazon Ads API v1 schema CreateBrandStoreSettings.
 */
final class CreateBrandStoreSettings extends AbstractModel
{
    /**
     * The exact component schema name from the Amazon OpenAPI document.
     */
    public const OPENAPI_NAME = 'CreateBrandStoreSettings';
    ...
    protected const ATTRIBUTE_DEFINITIONS = [
        ...
        'callToActions' => [
            'type' => 'model',
            'class' => CreateBrandStoreCallToAction::class,
            'required' => true,
            'nullable' => false,
        ],
        'clickTrackingUrls' => [
     ...
     *
     * @return CreateBrandStoreCallToAction|null
     */
    public function getCallToActions(): ?CreateBrandStoreCallToAction
    {
        /** @var CreateBrandStoreCallToAction|null $value */
     ...
     *
     * @param CreateBrandStoreCallToAction|array<string, mixed>|null $value New property value.
     * @return $this
     */
    public function setCallToActions(CreateBrandStoreCallToAction|array|null $value): self
    {
