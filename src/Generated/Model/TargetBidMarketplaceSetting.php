...
/**
 * Represents the TargetBidMarketplaceSetting schema from Amazon Ads API v1.
 *
 * @generated from Amazon Ads API v1 schema TargetBidMarketplaceSetting.
 */
final class TargetBidMarketplaceSetting extends AbstractModel
{
    /**
     * The exact component schema name from the Amazon OpenAPI document.
     */
    public const OPENAPI_NAME = 'TargetBidMarketplaceSetting';
