 ...
 *
 * @generated from Amazon Ads API v1 schema ClickToUrlDisplayCallToActionSettings.
 */
final class ClickToUrlDisplayCallToActionSettings extends AbstractModel
{
    /**
     * The exact component schema name from the Amazon OpenAPI document.
     */
    public const OPENAPI_NAME = 'ClickToUrlDisplayCallToActionSettings';
