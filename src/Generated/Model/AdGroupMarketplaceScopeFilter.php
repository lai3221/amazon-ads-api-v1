...
/**
 * Represents the AdGroupMarketplaceScopeFilter schema from Amazon Ads API v1.
 *
 * @generated from Amazon Ads API v1 schema AdGroupMarketplaceScopeFilter.
 */
final class AdGroupMarketplaceScopeFilter extends AbstractModel
{
    /**
     * The exact component schema name from the Amazon OpenAPI document.
     */
    public const OPENAPI_NAME = 'AdGroupMarketplaceScopeFilter';
