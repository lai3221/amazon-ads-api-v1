 ...
 *
 * @generated from Amazon Ads API v1 schema CreateRuleExpression.
 */
final class CreateRuleExpression extends AbstractUnion
{
    /**
     * The exact component schema name from the Amazon OpenAPI document.
     */
    public const OPENAPI_NAME = 'CreateRuleExpression';
