...
/**
 * Represents the AdAssociationAdGroupIdFilter schema from Amazon Ads API v1.
 *
 * @generated from Amazon Ads API v1 schema AdAssociationAdGroupIdFilter.
 */
final class AdAssociationAdGroupIdFilter extends AbstractModel
{
    /**
     * The exact component schema name from the Amazon OpenAPI document.
     */
    public const OPENAPI_NAME = 'AdAssociationAdGroupIdFilter';
