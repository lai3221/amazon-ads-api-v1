...
/**
 * Represents the UpdateStreamingTvSettings schema from Amazon Ads API v1.
 *
 * @generated from Amazon Ads API v1 schema UpdateStreamingTvSettings.
 */
final class UpdateStreamingTvSettings extends AbstractModel
{
    /**
     * The exact component schema name from the Amazon OpenAPI document.
     */
    public const OPENAPI_NAME = 'UpdateStreamingTvSettings';
