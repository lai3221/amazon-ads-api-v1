...
/**
 * Represents the PixalateFraudInvalidTraffic schema from Amazon Ads API v1.
 *
 * @generated from Amazon Ads API v1 schema PixalateFraudInvalidTraffic.
 */
final class PixalateFraudInvalidTraffic extends AbstractModel
{
    /**
     * The exact component schema name from the Amazon OpenAPI document.
     */
    public const OPENAPI_NAME = 'PixalateFraudInvalidTraffic';
