...
/**
 * Represents the CampaignStateFilter schema from Amazon Ads API v1.
 *
 * @generated from Amazon Ads API v1 schema CampaignStateFilter.
 */
final class CampaignStateFilter extends AbstractModel
{
    /**
     * The exact component schema name from the Amazon OpenAPI document.
     */
    public const OPENAPI_NAME = 'CampaignStateFilter';
