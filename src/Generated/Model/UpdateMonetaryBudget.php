...
/**
 * Represents the UpdateMonetaryBudget schema from Amazon Ads API v1.
 *
 * @generated from Amazon Ads API v1 schema UpdateMonetaryBudget.
 */
final class UpdateMonetaryBudget extends AbstractModel
{
    /**
     * The exact component schema name from the Amazon OpenAPI document.
     */
    public const OPENAPI_NAME = 'UpdateMonetaryBudget';
