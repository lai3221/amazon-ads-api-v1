...
/**
 * Represents the CreatePacing schema from Amazon Ads API v1.
 *
 * @generated from Amazon Ads API v1 schema CreatePacing.
 */
final class CreatePacing extends AbstractModel
{
    /**
     * The exact component schema name from the Amazon OpenAPI document.
     */
    public const OPENAPI_NAME = 'CreatePacing';
