...
/**
 * Represents the CreateStoreCallToActionData schema from Amazon Ads API v1.
 *
 * @generated from Amazon Ads API v1 schema CreateStoreCallToActionData.
 */
final class CreateStoreCallToActionData extends AbstractModel
{
    /**
     * The exact component schema name from the Amazon OpenAPI document.
     */
    public const OPENAPI_NAME = 'CreateStoreCallToActionData';
