 ...
 *
 * @generated from Amazon Ads API v1 schema CreateDimensionRuleAction.
 */
final class CreateDimensionRuleAction extends AbstractUnion
{
    /**
     * The exact component schema name from the Amazon OpenAPI document.
     */
    public const OPENAPI_NAME = 'CreateDimensionRuleAction';
