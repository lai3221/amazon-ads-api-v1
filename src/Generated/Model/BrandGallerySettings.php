 ...
 *
 * @generated from Amazon Ads API v1 schema BrandGallerySettings.
 */
final class BrandGallerySettings extends AbstractModel
{
    /**
     * The exact component schema name from the Amazon OpenAPI document.
     */
    public const OPENAPI_NAME = 'BrandGallerySettings';
    ...
    protected const ATTRIBUTE_DEFINITIONS = [
        ...
        'cards' => [
            ...
            'items' => [
                'type' => 'model',
                'class' => BrandGalleryCardCreativeElement::class,
            ],
            'required' => true,
            'nullable' => false,
            'minItems' => 3,
     ...
     *
     * @return list<BrandGalleryCardCreativeElement>|null
     */
    public function getCards(): ?array
    {
        /** @var list<BrandGalleryCardCreativeElement>|null $value */
     ...
     *
     * @param list<BrandGalleryCardCreativeElement>|null $value New property value.
     * @return $this
     */
