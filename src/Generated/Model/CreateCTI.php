...
/**
 * Represents the CreateCTI schema from Amazon Ads API v1.
 *
 * @generated from Amazon Ads API v1 schema CreateCTI.
 */
final class CreateCTI extends AbstractModel
{
    /**
     * The exact component schema name from the Amazon OpenAPI document.
     */
    public const OPENAPI_NAME = 'CreateCTI';
