...
/**
 * Represents the AdExtensionAdExtensionIdFilter schema from Amazon Ads API v1.
 *
 * @generated from Amazon Ads API v1 schema AdExtensionAdExtensionIdFilter.
 */
final class AdExtensionAdExtensionIdFilter extends AbstractModel
{
    /**
     * The exact component schema name from the Amazon OpenAPI document.
     */
    public const OPENAPI_NAME = 'AdExtensionAdExtensionIdFilter';
