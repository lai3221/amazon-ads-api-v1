...
/**
 * Represents the StoreImageSlide schema from Amazon Ads API v1.
 *
 * @generated from Amazon Ads API v1 schema StoreImageSlide.
 */
final class StoreImageSlide extends AbstractModel
{
    /**
     * The exact component schema name from the Amazon OpenAPI document.
     */
    public const OPENAPI_NAME = 'StoreImageSlide';
