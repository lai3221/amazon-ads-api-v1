 ...
 *
 * @generated from Amazon Ads API v1 schema CreateStoreVideoRevealWidget.
 */
final class CreateStoreVideoRevealWidget extends AbstractModel
{
    /**
     * The exact component schema name from the Amazon OpenAPI document.
     */
    public const OPENAPI_NAME = 'CreateStoreVideoRevealWidget';
    ...
    protected const ATTRIBUTE_DEFINITIONS = [
        ...
        'videos' => [
            'type' => 'model',
            'class' => CreateStoreVideoRevealVideos::class,
            'required' => true,
            'nullable' => false,
        ],
    ];
     ...
     *
     * @return CreateStoreVideoRevealVideos|null
     */
    public function getVideos(): ?CreateStoreVideoRevealVideos
    {
        /** @var CreateStoreVideoRevealVideos|null $value */
     ...
     *
     * @param CreateStoreVideoRevealVideos|array<string, mixed>|null $value New property value.
     * @return $this
     */
    public function setVideos(CreateStoreVideoRevealVideos|array|null $value): self
    {
