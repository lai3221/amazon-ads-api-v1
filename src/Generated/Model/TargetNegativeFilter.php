...
/**
 * Represents the TargetNegativeFilter schema from Amazon Ads API v1.
 *
 * @generated from Amazon Ads API v1 schema TargetNegativeFilter.
 */
final class TargetNegativeFilter extends AbstractModel
{
    /**
     * The exact component schema name from the Amazon OpenAPI document.
     */
    public const OPENAPI_NAME = 'TargetNegativeFilter';
