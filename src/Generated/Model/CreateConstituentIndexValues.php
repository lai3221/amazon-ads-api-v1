...
/**
 * Represents the CreateConstituentIndexValues schema from Amazon Ads API v1.
 *
 * @generated from Amazon Ads API v1 schema CreateConstituentIndexValues.
 */
final class CreateConstituentIndexValues extends AbstractModel
{
    /**
     * The exact component schema name from the Amazon OpenAPI document.
     */
    public const OPENAPI_NAME = 'CreateConstituentIndexValues';
