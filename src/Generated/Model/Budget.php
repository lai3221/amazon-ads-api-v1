...
/**
 * Represents the Budget schema from Amazon Ads API v1.
 *
 * @generated from Amazon Ads API v1 schema Budget.
 */
final class Budget extends AbstractModel
{
    /**
     * The exact component schema name from the Amazon OpenAPI document.
     */
    public const OPENAPI_NAME = 'Budget';
