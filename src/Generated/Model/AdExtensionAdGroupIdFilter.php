...
/**
 * Represents the AdExtensionAdGroupIdFilter schema from Amazon Ads API v1.
 *
 * @generated from Amazon Ads API v1 schema AdExtensionAdGroupIdFilter.
 */
final class AdExtensionAdGroupIdFilter extends AbstractModel
{
    /**
     * The exact component schema name from the Amazon OpenAPI document.
     */
    public const OPENAPI_NAME = 'AdExtensionAdGroupIdFilter';
