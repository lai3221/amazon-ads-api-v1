...
/**
 * Represents the SellerSellerParentIdFilter schema from Amazon Ads API v1.
 *
 * @generated from Amazon Ads API v1 schema SellerSellerParentIdFilter.
 */
final class SellerSellerParentIdFilter extends AbstractModel
{
    /**
     * The exact component schema name from the Amazon OpenAPI document.
     */
    public const OPENAPI_NAME = 'SellerSellerParentIdFilter';
