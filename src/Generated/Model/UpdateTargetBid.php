...
/**
 * Represents the UpdateTargetBid schema from Amazon Ads API v1.
 *
 * @generated from Amazon Ads API v1 schema UpdateTargetBid.
 */
final class UpdateTargetBid extends AbstractModel
{
    /**
     * The exact component schema name from the Amazon OpenAPI document.
     */
    public const OPENAPI_NAME = 'UpdateTargetBid';
