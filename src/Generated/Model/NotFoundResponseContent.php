...
/**
 * Represents the NotFoundResponseContent schema from Amazon Ads API v1.
 *
 * @generated from Amazon Ads API v1 schema NotFoundResponseContent.
 */
final class NotFoundResponseContent extends AbstractModel
{
    /**
     * The exact component schema name from the Amazon OpenAPI document.
     */
    public const OPENAPI_NAME = 'NotFoundResponseContent';
