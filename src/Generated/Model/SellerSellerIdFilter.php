...
/**
 * Represents the SellerSellerIdFilter schema from Amazon Ads API v1.
 *
 * @generated from Amazon Ads API v1 schema SellerSellerIdFilter.
 */
final class SellerSellerIdFilter extends AbstractModel
{
    /**
     * The exact component schema name from the Amazon OpenAPI document.
     */
    public const OPENAPI_NAME = 'SellerSellerIdFilter';
