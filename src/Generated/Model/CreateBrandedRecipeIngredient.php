 ...
 *
 * @generated from Amazon Ads API v1 schema CreateBrandedRecipeIngredient.
 */
final class CreateBrandedRecipeIngredient extends AbstractModel
{
    /**
     * The exact component schema name from the Amazon OpenAPI document.
     */
    public const OPENAPI_NAME = 'CreateBrandedRecipeIngredient';
    ...
    protected const ATTRIBUTE_DEFINITIONS = [
        ...
        'quantityList' => [
            ...
            'items' => [
                'type' => 'model',
                'class' => CreateBrandedRecipeQuantityItem::class,
            ],
            'required' => false,
            'nullable' => false,
            'minItems' => 0,
     ...
     *
     * @return list<CreateBrandedRecipeQuantityItem>|null
     */
    public function getQuantityList(): ?array
    {
        /** @var list<CreateBrandedRecipeQuantityItem>|null $value */
     ...
     *
     * @param list<CreateBrandedRecipeQuantityItem>|null $value New property value.
     * @return $this
     */
