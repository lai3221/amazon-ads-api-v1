...
/**
 * Represents the AdAdIdFilter schema from Amazon Ads API v1.
 *
 * @generated from Amazon Ads API v1 schema AdAdIdFilter.
 */
final class AdAdIdFilter extends AbstractModel
{
    /**
     * The exact component schema name from the Amazon OpenAPI document.
     */
    public const OPENAPI_NAME = 'AdAdIdFilter';
