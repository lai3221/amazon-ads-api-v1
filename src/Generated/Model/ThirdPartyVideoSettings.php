...
/**
 * Represents the ThirdPartyVideoSettings schema from Amazon Ads API v1.
 *
 * @generated from Amazon Ads API v1 schema ThirdPartyVideoSettings.
 */
final class ThirdPartyVideoSettings extends AbstractModel
{
    /**
     * The exact component schema name from the Amazon OpenAPI document.
     */
    public const OPENAPI_NAME = 'ThirdPartyVideoSettings';
