...
/**
 * Represents the StoreMobileImageContent schema from Amazon Ads API v1.
 *
 * @generated from Amazon Ads API v1 schema StoreMobileImageContent.
 */
final class StoreMobileImageContent extends AbstractModel
{
    /**
     * The exact component schema name from the Amazon OpenAPI document.
     */
    public const OPENAPI_NAME = 'StoreMobileImageContent';
