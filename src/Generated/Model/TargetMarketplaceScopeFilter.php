...
/**
 * Represents the TargetMarketplaceScopeFilter schema from Amazon Ads API v1.
 *
 * @generated from Amazon Ads API v1 schema TargetMarketplaceScopeFilter.
 */
final class TargetMarketplaceScopeFilter extends AbstractModel
{
    /**
     * The exact component schema name from the Amazon OpenAPI document.
     */
    public const OPENAPI_NAME = 'TargetMarketplaceScopeFilter';
