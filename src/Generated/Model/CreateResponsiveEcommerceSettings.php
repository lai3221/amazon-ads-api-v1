...
/**
 * Represents the CreateResponsiveEcommerceSettings schema from Amazon Ads API v1.
 *
 * @generated from Amazon Ads API v1 schema CreateResponsiveEcommerceSettings.
 */
final class CreateResponsiveEcommerceSettings extends AbstractModel
{
    /**
     * The exact component schema name from the Amazon OpenAPI document.
     */
    public const OPENAPI_NAME = 'CreateResponsiveEcommerceSettings';
    ...
    protected const ATTRIBUTE_DEFINITIONS = [
        ...
        'landingPage' => [
            'type' => 'model',
            'class' => CreateResponsiveEcommerceLandingPage::class,
            'required' => false,
            'nullable' => false,
        ],
        'language' => [
     ...
     *
     * @return CreateResponsiveEcommerceLandingPage|null
     */
    public function getLandingPage(): ?CreateResponsiveEcommerceLandingPage
    {
        /** @var CreateResponsiveEcommerceLandingPage|null $value */
     ...
     *
     * @param CreateResponsiveEcommerceLandingPage|array<string, mixed>|null $value New property value.
     * @return $this
     */
    public function setLandingPage(CreateResponsiveEcommerceLandingPage|array|null $value): self
    {
     ...
     */
    public function getLogos(): ?CreateImage
    {
     ...
     * @return $this
     */
    public function setLogos(CreateImage|array|null $value): self
    {
