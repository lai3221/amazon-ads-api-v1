...
/**
 * Represents the CommonWidgetProperties schema from Amazon Ads API v1.
 *
 * @generated from Amazon Ads API v1 schema CommonWidgetProperties.
 */
final class CommonWidgetProperties extends AbstractModel
{
    /**
     * The exact component schema name from the Amazon OpenAPI document.
     */
    public const OPENAPI_NAME = 'CommonWidgetProperties';
