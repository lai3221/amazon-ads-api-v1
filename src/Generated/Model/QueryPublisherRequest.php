...
/**
 * Represents the QueryPublisherRequest schema from Amazon Ads API v1.
 *
 * @generated from Amazon Ads API v1 schema QueryPublisherRequest.
 */
final class QueryPublisherRequest extends AbstractModel
{
    /**
     * The exact component schema name from the Amazon OpenAPI document.
     */
    public const OPENAPI_NAME = 'QueryPublisherRequest';
