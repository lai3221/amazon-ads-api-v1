...
/**
 * Represents the IntegralAdScienceFraudInvalidTraffic schema from Amazon Ads API v1.
 *
 * @generated from Amazon Ads API v1 schema IntegralAdScienceFraudInvalidTraffic.
 */
final class IntegralAdScienceFraudInvalidTraffic extends AbstractModel
{
    /**
     * The exact component schema name from the Amazon OpenAPI document.
     */
    public const OPENAPI_NAME = 'IntegralAdScienceFraudInvalidTraffic';
