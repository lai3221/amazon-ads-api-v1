 ...
 *
 * @generated from Amazon Ads API v1 schema SellingAccountAddress.
 */
final class SellingAccountAddress extends AbstractModel
{
    /**
     * The exact component schema name from the Amazon OpenAPI document.
     */
    public const OPENAPI_NAME = 'SellingAccountAddress';
    ...
    /**
     * Returns The token to locate a business address..
     *
     * @return string|null
     */
    ...
    /**
     * Sets The token to locate a business address..
     *
     * @param string|null $value New property value.
     * @return $this
     */
