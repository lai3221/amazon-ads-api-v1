 ...
 *
 * @generated from Amazon Ads API v1 schema CreateStoreSpotlightSettings.
 */
final class CreateStoreSpotlightSettings extends AbstractModel
{
    /**
     * The exact component schema name from the Amazon OpenAPI document.
     */
    public const OPENAPI_NAME = 'CreateStoreSpotlightSettings';
