...
/**
 * Represents the StoreTileLayerContent schema from Amazon Ads API v1.
 *
 * @generated from Amazon Ads API v1 schema StoreTileLayerContent.
 */
final class StoreTileLayerContent extends AbstractModel
{
    /**
     * The exact component schema name from the Amazon OpenAPI document.
     */
    public const OPENAPI_NAME = 'StoreTileLayerContent';
