...
/**
 * Represents the TwitchContentRating schema from Amazon Ads API v1.
 *
 * @generated from Amazon Ads API v1 schema TwitchContentRating.
 */
final class TwitchContentRating extends AbstractModel
{
    /**
     * The exact component schema name from the Amazon OpenAPI document.
     */
    public const OPENAPI_NAME = 'TwitchContentRating';
