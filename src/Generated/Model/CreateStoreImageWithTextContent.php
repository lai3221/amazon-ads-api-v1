...
/**
 * Represents the CreateStoreImageWithTextContent schema from Amazon Ads API v1.
 *
 * @generated from Amazon Ads API v1 schema CreateStoreImageWithTextContent.
 */
final class CreateStoreImageWithTextContent extends AbstractModel
{
    /**
     * The exact component schema name from the Amazon OpenAPI document.
     */
    public const OPENAPI_NAME = 'CreateStoreImageWithTextContent';
