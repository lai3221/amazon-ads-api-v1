...
/**
 * Represents the AdGroupAdGroupIdFilter schema from Amazon Ads API v1.
 *
 * @generated from Amazon Ads API v1 schema AdGroupAdGroupIdFilter.
 */
final class AdGroupAdGroupIdFilter extends AbstractModel
{
    /**
     * The exact component schema name from the Amazon OpenAPI document.
     */
    public const OPENAPI_NAME = 'AdGroupAdGroupIdFilter';
