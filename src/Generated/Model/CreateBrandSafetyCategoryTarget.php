 ...
 *
 * @generated from Amazon Ads API v1 schema CreateBrandSafetyCategoryTarget.
 */
final class CreateBrandSafetyCategoryTarget extends AbstractModel
{
    /**
     * The exact component schema name from the Amazon OpenAPI document.
     */
    public const OPENAPI_NAME = 'CreateBrandSafetyCategoryTarget';
