...
/**
 * Represents the AdExtensionStateFilter schema from Amazon Ads API v1.
 *
 * @generated from Amazon Ads API v1 schema AdExtensionStateFilter.
 */
final class AdExtensionStateFilter extends AbstractModel
{
    /**
     * The exact component schema name from the Amazon OpenAPI document.
     */
    public const OPENAPI_NAME = 'AdExtensionStateFilter';
