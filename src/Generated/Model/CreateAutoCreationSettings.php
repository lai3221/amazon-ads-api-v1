...
/**
 * Represents the CreateAutoCreationSettings schema from Amazon Ads API v1.
 *
 * @generated from Amazon Ads API v1 schema CreateAutoCreationSettings.
 */
final class CreateAutoCreationSettings extends AbstractModel
{
    /**
     * The exact component schema name from the Amazon OpenAPI document.
     */
    public const OPENAPI_NAME = 'CreateAutoCreationSettings';
