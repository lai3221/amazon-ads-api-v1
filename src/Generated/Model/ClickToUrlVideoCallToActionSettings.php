...
/**
 * Represents the ClickToUrlVideoCallToActionSettings schema from Amazon Ads API v1.
 *
 * @generated from Amazon Ads API v1 schema ClickToUrlVideoCallToActionSettings.
 */
final class ClickToUrlVideoCallToActionSettings extends AbstractModel
{
    /**
     * The exact component schema name from the Amazon OpenAPI document.
     */
    public const OPENAPI_NAME = 'ClickToUrlVideoCallToActionSettings';
