...
/**
 * Represents the CreateIntegralAdScienceContextualAvoidance schema from Amazon Ads API v1.
 *
 * @generated from Amazon Ads API v1 schema CreateIntegralAdScienceContextualAvoidance.
 */
final class CreateIntegralAdScienceContextualAvoidance extends AbstractModel
{
    /**
     * The exact component schema name from the Amazon OpenAPI document.
     */
    public const OPENAPI_NAME = 'CreateIntegralAdScienceContextualAvoidance';
