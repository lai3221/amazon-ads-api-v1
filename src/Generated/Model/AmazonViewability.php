...
/**
 * Represents the AmazonViewability schema from Amazon Ads API v1.
 *
 * @generated from Amazon Ads API v1 schema AmazonViewability.
 */
final class AmazonViewability extends AbstractModel
{
    /**
     * The exact component schema name from the Amazon OpenAPI document.
     */
    public const OPENAPI_NAME = 'AmazonViewability';
