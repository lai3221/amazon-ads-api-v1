...
/**
 * Represents the DatePeriod schema from Amazon Ads API v1.
 *
 * @generated from Amazon Ads API v1 schema DatePeriod.
 */
final class DatePeriod extends AbstractModel
{
    /**
     * The exact component schema name from the Amazon OpenAPI document.
     */
    public const OPENAPI_NAME = 'DatePeriod';
