 ...
 *
 * @generated from Amazon Ads API v1 schema CreateStoreProductSelectorAnswer.
 */
final class CreateStoreProductSelectorAnswer extends AbstractModel
{
    /**
     * The exact component schema name from the Amazon OpenAPI document.
     */
    public const OPENAPI_NAME = 'CreateStoreProductSelectorAnswer';
