...
/**
 * Represents the StoreProductGridSearch schema from Amazon Ads API v1.
 *
 * @generated from Amazon Ads API v1 schema StoreProductGridSearch.
 */
final class StoreProductGridSearch extends AbstractModel
{
    /**
     * The exact component schema name from the Amazon OpenAPI document.
     */
    public const OPENAPI_NAME = 'StoreProductGridSearch';
