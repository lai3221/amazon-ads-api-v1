...
/**
 * Represents the BadRequestResponseContent schema from Amazon Ads API v1.
 *
 * @generated from Amazon Ads API v1 schema BadRequestResponseContent.
 */
final class BadRequestResponseContent extends AbstractModel
{
    /**
     * The exact component schema name from the Amazon OpenAPI document.
     */
    public const OPENAPI_NAME = 'BadRequestResponseContent';
