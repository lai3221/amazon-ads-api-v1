 ...
 *
 * @generated from Amazon Ads API v1 schema NativeContentPositionTarget.
 */
final class NativeContentPositionTarget extends AbstractModel
{
    /**
     * The exact component schema name from the Amazon OpenAPI document.
     */
    public const OPENAPI_NAME = 'NativeContentPositionTarget';
