...
/**
 * Represents the ResponsiveEcommerceLandingPage schema from Amazon Ads API v1.
 *
 * @generated from Amazon Ads API v1 schema ResponsiveEcommerceLandingPage.
 */
final class ResponsiveEcommerceLandingPage extends AbstractModel
{
    /**
     * The exact component schema name from the Amazon OpenAPI document.
     */
    public const OPENAPI_NAME = 'ResponsiveEcommerceLandingPage';
