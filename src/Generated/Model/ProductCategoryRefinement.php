...
/**
 * Represents the ProductCategoryRefinement schema from Amazon Ads API v1.
 *
 * @generated from Amazon Ads API v1 schema ProductCategoryRefinement.
 */
final class ProductCategoryRefinement extends AbstractModel
{
    /**
     * The exact component schema name from the Amazon OpenAPI document.
     */
    public const OPENAPI_NAME = 'ProductCategoryRefinement';
