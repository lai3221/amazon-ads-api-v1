...
/**
 * Represents the AdAdGroupIdFilter schema from Amazon Ads API v1.
 *
 * @generated from Amazon Ads API v1 schema AdAdGroupIdFilter.
 */
final class AdAdGroupIdFilter extends AbstractModel
{
    /**
     * The exact component schema name from the Amazon OpenAPI document.
     */
    public const OPENAPI_NAME = 'AdAdGroupIdFilter';
