...
/**
 * Represents the CreateStandardDisplaySettings schema from Amazon Ads API v1.
 *
 * @generated from Amazon Ads API v1 schema CreateStandardDisplaySettings.
 */
final class CreateStandardDisplaySettings extends AbstractModel
{
    /**
     * The exact component schema name from the Amazon OpenAPI document.
     */
    public const OPENAPI_NAME = 'CreateStandardDisplaySettings';
    ...
    protected const ATTRIBUTE_DEFINITIONS = [
        ...
        'callToAction' => [
            'type' => 'model',
            'class' => CreateDisplayCallToAction::class,
            'required' => false,
            'nullable' => false,
        ],
        'clickTrackingUrls' => [
     ...
     *
     * @return CreateDisplayCallToAction|null
     */
    public function getCallToAction(): ?CreateDisplayCallToAction
    {
        /** @var CreateDisplayCallToAction|null $value */
     ...
     *
     * @param CreateDisplayCallToAction|array<string, mixed>|null $value New property value.
     * @return $this
     */
    public function setCallToAction(CreateDisplayCallToAction|array|null $value): self
    {
