...
/**
 * Represents the AdGroupCampaignIdFilter schema from Amazon Ads API v1.
 *
 * @generated from Amazon Ads API v1 schema AdGroupCampaignIdFilter.
 */
final class AdGroupCampaignIdFilter extends AbstractModel
{
    /**
     * The exact component schema name from the Amazon OpenAPI document.
     */
    public const OPENAPI_NAME = 'AdGroupCampaignIdFilter';
