...
/**
 * Represents the CreateStoreProductGridContent schema from Amazon Ads API v1.
 *
 * @generated from Amazon Ads API v1 schema CreateStoreProductGridContent.
 */
final class CreateStoreProductGridContent extends AbstractModel
{
    /**
     * The exact component schema name from the Amazon OpenAPI document.
     */
    public const OPENAPI_NAME = 'CreateStoreProductGridContent';
    ...
    protected const ATTRIBUTE_DEFINITIONS = [
        ...
        'search' => [
            'type' => 'model',
            'class' => CreateStoreProductGridSearch::class,
            'required' => false,
            'nullable' => false,
        ],
        'showOnlyMarkdown' => [
     ...
     *
     * @return CreateStoreProductGridSearch|null
     */
    public function getSearch(): ?CreateStoreProductGridSearch
    {
        /** @var CreateStoreProductGridSearch|null $value */
     ...
     *
     * @param CreateStoreProductGridSearch|array<string, mixed>|null $value New property value.
     * @return $this
     */
    public function setSearch(CreateStoreProductGridSearch|array|null $value): self
    {
