...
/**
 * Represents the CreateVideo schema from Amazon Ads API v1.
 *
 * @generated from Amazon Ads API v1 schema CreateVideo.
 */
final class CreateVideo extends AbstractModel
{
    /**
     * The exact component schema name from the Amazon OpenAPI document.
     */
    public const OPENAPI_NAME = 'CreateVideo';
