...
/**
 * Represents the UpdateAssetBasedCreativeSettings schema from Amazon Ads API v1.
 *
 * @generated from Amazon Ads API v1 schema UpdateAssetBasedCreativeSettings.
 */
final class UpdateAssetBasedCreativeSettings extends AbstractModel
{
    /**
     * The exact component schema name from the Amazon OpenAPI document.
     */
    public const OPENAPI_NAME = 'UpdateAssetBasedCreativeSettings';
    ...
    protected const ATTRIBUTE_DEFINITIONS = [
        ...
        'callToActions' => [
            'type' => 'model',
            'class' => UpdateAssetBasedCreativeCallToAction::class,
            'required' => false,
            'nullable' => false,
        ],
        'clickTrackingUrls' => [
     ...
     *
     * @return UpdateAssetBasedCreativeCallToAction|null
     */
    public function getCallToActions(): ?UpdateAssetBasedCreativeCallToAction
    {
        /** @var UpdateAssetBasedCreativeCallToAction|null $value */
     ...
     *
     * @param UpdateAssetBasedCreativeCallToAction|array<string, mixed>|null $value New property value.
     * @return $this
     */
    public function setCallToActions(UpdateAssetBasedCreativeCallToAction|array|null $value): self
    {
     ...
     *
     * @return UpdateVideo|null
     */
    public function getCustomVideos(): ?UpdateVideo
    {
        /** @var UpdateVideo|null $value */
     ...
     *
     * @param UpdateVideo|array<string, mixed>|null $value New property value.
     * @return $this
     */
    public function setCustomVideos(UpdateVideo|array|null $value): self
    {
