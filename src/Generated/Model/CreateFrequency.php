...
/**
 * Represents the CreateFrequency schema from Amazon Ads API v1.
 *
 * @generated from Amazon Ads API v1 schema CreateFrequency.
 */
final class CreateFrequency extends AbstractModel
{
    /**
     * The exact component schema name from the Amazon OpenAPI document.
     */
    public const OPENAPI_NAME = 'CreateFrequency';
