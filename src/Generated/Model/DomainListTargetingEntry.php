...
/**
 * A domain list targeting entry. All entries must share the same negative value.
 *
 * @generated from Amazon Ads API v1 schema DomainListTargetingEntry.
 */
final class DomainListTargetingEntry extends AbstractModel
{
    /**
     * The exact component schema name from the Amazon OpenAPI document.
     */
    public const OPENAPI_NAME = 'DomainListTargetingEntry';
    ...
    /**
     * Returns The domain list to target..
     *
     * @return string|null
     */
    ...
    /**
     * Sets The domain list to target..
     *
