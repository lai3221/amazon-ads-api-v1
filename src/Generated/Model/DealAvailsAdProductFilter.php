...
/**
 * Represents the DealAvailsAdProductFilter schema from Amazon Ads API v1.
 *
 * @generated from Amazon Ads API v1 schema DealAvailsAdProductFilter.
 */
final class DealAvailsAdProductFilter extends AbstractModel
{
    /**
     * The exact component schema name from the Amazon OpenAPI document.
     */
    public const OPENAPI_NAME = 'DealAvailsAdProductFilter';
