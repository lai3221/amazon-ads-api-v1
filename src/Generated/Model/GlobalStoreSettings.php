...
/**
 * Represents the GlobalStoreSettings schema from Amazon Ads API v1.
 *
 * @generated from Amazon Ads API v1 schema GlobalStoreSettings.
 */
final class GlobalStoreSettings extends AbstractModel
{
    /**
     * The exact component schema name from the Amazon OpenAPI document.
     */
    public const OPENAPI_NAME = 'GlobalStoreSettings';
