...
/**
 * Represents the CreateStoreProductCollectionImageTile schema from Amazon Ads API v1.
 *
 * @generated from Amazon Ads API v1 schema CreateStoreProductCollectionImageTile.
 */
final class CreateStoreProductCollectionImageTile extends AbstractModel
{
    /**
     * The exact component schema name from the Amazon OpenAPI document.
     */
    public const OPENAPI_NAME = 'CreateStoreProductCollectionImageTile';
