...
/**
 * Represents the UpdateBudgetSettings schema from Amazon Ads API v1.
 *
 * @generated from Amazon Ads API v1 schema UpdateBudgetSettings.
 */
final class UpdateBudgetSettings extends AbstractModel
{
    /**
     * The exact component schema name from the Amazon OpenAPI document.
     */
    public const OPENAPI_NAME = 'UpdateBudgetSettings';
