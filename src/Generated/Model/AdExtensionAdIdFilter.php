...
/**
 * Represents the AdExtensionAdIdFilter schema from Amazon Ads API v1.
 *
 * @generated from Amazon Ads API v1 schema AdExtensionAdIdFilter.
 */
final class AdExtensionAdIdFilter extends AbstractModel
{
    /**
     * The exact component schema name from the Amazon OpenAPI document.
     */
    public const OPENAPI_NAME = 'AdExtensionAdIdFilter';
