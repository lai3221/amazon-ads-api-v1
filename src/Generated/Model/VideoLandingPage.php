...
/**
 * Represents the VideoLandingPage schema from Amazon Ads API v1.
 *
 * @generated from Amazon Ads API v1 schema VideoLandingPage.
 */
final class VideoLandingPage extends AbstractModel
{
    /**
     * The exact component schema name from the Amazon OpenAPI document.
     */
    public const OPENAPI_NAME = 'VideoLandingPage';
