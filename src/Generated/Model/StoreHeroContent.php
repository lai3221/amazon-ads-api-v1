...
/**
 * Represents the StoreHeroContent schema from Amazon Ads API v1.
 *
 * @generated from Amazon Ads API v1 schema StoreHeroContent.
 */
final class StoreHeroContent extends AbstractModel
{
    /**
     * The exact component schema name from the Amazon OpenAPI document.
     */
    public const OPENAPI_NAME = 'StoreHeroContent';
    ...
    protected const ATTRIBUTE_DEFINITIONS = [
        ...
        'mobileContent' => [
            'type' => 'model',
            'class' => StoreMobileContent::class,
            'required' => false,
            'nullable' => false,
        ],
        'tag' => [
     ...
     *
     * @return StoreMobileContent|null
     */
    public function getMobileContent(): ?StoreMobileContent
    {
        /** @var StoreMobileContent|null $value */
     ...
     *
     * @param StoreMobileContent|array<string, mixed>|null $value New property value.
     * @return $this
     */
    public function setMobileContent(StoreMobileContent|array|null $value): self
    {
