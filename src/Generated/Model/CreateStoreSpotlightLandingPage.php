...
/**
 * Represents the CreateStoreSpotlightLandingPage schema from Amazon Ads API v1.
 *
 * @generated from Amazon Ads API v1 schema CreateStoreSpotlightLandingPage.
 */
final class CreateStoreSpotlightLandingPage extends AbstractModel
{
    /**
     * The exact component schema name from the Amazon OpenAPI document.
     */
    public const OPENAPI_NAME = 'CreateStoreSpotlightLandingPage';
