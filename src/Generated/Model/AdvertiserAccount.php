...
/**
 * Represents the AdvertiserAccount schema from Amazon Ads API v1.
 *
 * @generated from Amazon Ads API v1 schema AdvertiserAccount.
 */
final class AdvertiserAccount extends AbstractModel
{
    /**
     * The exact component schema name from the Amazon OpenAPI document.
     */
    public const OPENAPI_NAME = 'AdvertiserAccount';
    ...
    protected const ATTRIBUTE_DEFINITIONS = [
        ...
        'alternateIds' => [
            ...
            'items' => [
                'type' => 'model',
                'class' => AlternateIdentifier::class,
            ],
            'required' => false,
            'nullable' => false,
            'minItems' => 0,
        ...
        'sellingAccountLinkRequests' => [
            ...
            'items' => [
                'type' => 'model',
                'class' => SellingAccountLinkRequest::class,
            ],
            'required' => false,
            'nullable' => false,
            'minItems' => 0,
        ...
        'status' => [
            'type' => 'model',
            'class' => AdvertiserAccountStatus::class,
            'required' => true,
            'nullable' => false,
        ],
        'timeZoneIana' => [
    ...
    /**
     * Returns The list of additional identifiers associated with advertising account..
     *
     * @return list<AlternateIdentifier>|null
     */
    public function getAlternateIds(): ?array
    {
        /** @var list<AlternateIdentifier>|null $value */
        $value = $this->getAttribute('alternateIds');

        return $value;
    }

    /**
     * Sets The list of additional identifiers associated with advertising account..
     *
     * @param list<AlternateIdentifier>|null $value New property value.
     * @return $this
     */
    public function setAlternateIds(?array $value): self
    {
        $this->setAttribute('alternateIds', $value);
     ...
     *
     * @return list<BusinessDetail>|null
     */
    public function getBusinessDetails(): ?array
    {
        /** @var list<BusinessDetail>|null $value */
     ...
     *
     * @param list<BusinessDetail>|null $value New property value.
     * @return $this
     */
     ...
     *
     * @return list<SellingAccountLinkRequest>|null
     */
    public function getSellingAccountLinkRequests(): ?array
    {
        /** @var list<SellingAccountLinkRequest>|null $value */
     ...
     *
     * @param list<SellingAccountLinkRequest>|null $value New property value.
     * @return $this
     */
     ...
     *
     * @return AdvertiserAccountStatus|null
     */
    public function getStatus(): ?AdvertiserAccountStatus
    {
        /** @var AdvertiserAccountStatus|null $value */
     ...
     *
     * @param AdvertiserAccountStatus|array<string, mixed>|null $value New property value.
     * @return $this
     */
    public function setStatus(AdvertiserAccountStatus|array|null $value): self
    {
