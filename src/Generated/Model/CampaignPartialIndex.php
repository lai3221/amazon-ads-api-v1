...
/**
 * Represents the CampaignPartialIndex schema from Amazon Ads API v1.
 *
 * @generated from Amazon Ads API v1 schema CampaignPartialIndex.
 */
final class CampaignPartialIndex extends AbstractModel
{
    /**
     * The exact component schema name from the Amazon OpenAPI document.
     */
    public const OPENAPI_NAME = 'CampaignPartialIndex';
