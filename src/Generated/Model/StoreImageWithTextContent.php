...
/**
 * Represents the StoreImageWithTextContent schema from Amazon Ads API v1.
 *
 * @generated from Amazon Ads API v1 schema StoreImageWithTextContent.
 */
final class StoreImageWithTextContent extends AbstractModel
{
    /**
     * The exact component schema name from the Amazon OpenAPI document.
     */
    public const OPENAPI_NAME = 'StoreImageWithTextContent';
