...
/**
 * Represents the StoreBanners schema from Amazon Ads API v1.
 *
 * @generated from Amazon Ads API v1 schema StoreBanners.
 */
final class StoreBanners extends AbstractModel
{
    /**
     * The exact component schema name from the Amazon OpenAPI document.
     */
    public const OPENAPI_NAME = 'StoreBanners';
