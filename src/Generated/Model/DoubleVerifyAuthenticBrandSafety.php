...
/**
 * Represents the DoubleVerifyAuthenticBrandSafety schema from Amazon Ads API v1.
 *
 * @generated from Amazon Ads API v1 schema DoubleVerifyAuthenticBrandSafety.
 */
final class DoubleVerifyAuthenticBrandSafety extends AbstractModel
{
    /**
     * The exact component schema name from the Amazon OpenAPI document.
     */
    public const OPENAPI_NAME = 'DoubleVerifyAuthenticBrandSafety';
