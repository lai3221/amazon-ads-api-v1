...
/**
 * Represents the CampaignCampaignIdFilter schema from Amazon Ads API v1.
 *
 * @generated from Amazon Ads API v1 schema CampaignCampaignIdFilter.
 */
final class CampaignCampaignIdFilter extends AbstractModel
{
    /**
     * The exact component schema name from the Amazon OpenAPI document.
     */
    public const OPENAPI_NAME = 'CampaignCampaignIdFilter';
