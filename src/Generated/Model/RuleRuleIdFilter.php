...
/**
 * Represents the RuleRuleIdFilter schema from Amazon Ads API v1.
 *
 * @generated from Amazon Ads API v1 schema RuleRuleIdFilter.
 */
final class RuleRuleIdFilter extends AbstractModel
{
    /**
     * The exact component schema name from the Amazon OpenAPI document.
     */
    public const OPENAPI_NAME = 'RuleRuleIdFilter';
