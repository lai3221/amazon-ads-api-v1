 ...
 *
 * @generated from Amazon Ads API v1 schema CreateBrandGallerySettings.
 */
final class CreateBrandGallerySettings extends AbstractModel
{
    /**
     * The exact component schema name from the Amazon OpenAPI document.
     */
    public const OPENAPI_NAME = 'CreateBrandGallerySettings';
    ...
    protected const ATTRIBUTE_DEFINITIONS = [
        ...
        'cards' => [
            ...
            'items' => [
                'type' => 'model',
                'class' => CreateBrandGalleryCardCreativeElement::class,
            ],
            'required' => true,
            'nullable' => false,
            'minItems' => 3,
        ...
        'creativePropertiesToOptimize' => [
            ...
            'items' => [
                'type' => 'enum',
                'class' => BrandGalleryCreativePropertiesToOptimize::class,
            ],
            'required' => false,
            'nullable' => false,
            'minItems' => 0,
    ...
    /**
     * Returns The sub-elements of the creative. Each card highlights a different category associated to a brand..
     *
     * @return list<CreateBrandGalleryCardCreativeElement>|null
     */
    public function getCards(): ?array
    {
        /** @var list<CreateBrandGalleryCardCreativeElement>|null $value */
    ...
    /**
     * Sets The sub-elements of the creative. Each card highlights a different category associated to a brand..
     *
     * @param list<CreateBrandGalleryCardCreativeElement>|null $value New property value.
     * @return $this
     */
     ...
     *
     * @return list<BrandGalleryCreativePropertiesToOptimize>|null
     */
    public function getCreativePropertiesToOptimize(): ?array
    {
        /** @var list<BrandGalleryCreativePropertiesToOptimize>|null $value */
     ...
     *
     * @param list<BrandGalleryCreativePropertiesToOptimize>|null $value New property value.
     * @return $this
     */
    ...
    /**
     * Returns The custom images featured in the ad..
     *
     * @return list<CreateImage>|null
     */
    ...
    /**
     * Sets The custom images featured in the ad..
     *
     * @param list<CreateImage>|null $value New property value.
     * @return $this
     */
