...
/**
 * Represents the CreateStoreCustomCodeWidget schema from Amazon Ads API v1.
 *
 * @generated from Amazon Ads API v1 schema CreateStoreCustomCodeWidget.
 */
final class CreateStoreCustomCodeWidget extends AbstractModel
{
    /**
     * The exact component schema name from the Amazon OpenAPI document.
     */
    public const OPENAPI_NAME = 'CreateStoreCustomCodeWidget';
    ...
    protected const ATTRIBUTE_DEFINITIONS = [
        ...
        'tiles' => [
            ...
            'items' => [
                'type' => 'model',
                'class' => CreateStoreCustomCodeTile::class,
            ],
            'required' => true,
            'nullable' => false,
            'minItems' => 1,
     ...
     *
     * @return list<CreateStoreCustomCodeTile>|null
     */
    public function getTiles(): ?array
    {
        /** @var list<CreateStoreCustomCodeTile>|null $value */
     ...
     *
     * @param list<CreateStoreCustomCodeTile>|null $value New property value.
     * @return $this
     */
