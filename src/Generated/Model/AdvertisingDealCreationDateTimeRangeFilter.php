...
/**
 * Represents the AdvertisingDealCreationDateTimeRangeFilter schema from Amazon Ads API v1.
 *
 * @generated from Amazon Ads API v1 schema AdvertisingDealCreationDateTimeRangeFilter.
 */
final class AdvertisingDealCreationDateTimeRangeFilter extends AbstractModel
{
    /**
     * The exact component schema name from the Amazon OpenAPI document.
     */
    public const OPENAPI_NAME = 'AdvertisingDealCreationDateTimeRangeFilter';
