...
/**
 * Represents the CreateAudio schema from Amazon Ads API v1.
 *
 * @generated from Amazon Ads API v1 schema CreateAudio.
 */
final class CreateAudio extends AbstractModel
{
    /**
     * The exact component schema name from the Amazon OpenAPI document.
     */
    public const OPENAPI_NAME = 'CreateAudio';
