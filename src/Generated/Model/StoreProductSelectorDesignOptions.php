 ...
 *
 * @generated from Amazon Ads API v1 schema StoreProductSelectorDesignOptions.
 */
final class StoreProductSelectorDesignOptions extends AbstractModel
{
    /**
     * The exact component schema name from the Amazon OpenAPI document.
     */
    public const OPENAPI_NAME = 'StoreProductSelectorDesignOptions';
