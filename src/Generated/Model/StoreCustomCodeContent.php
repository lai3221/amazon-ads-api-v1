...
/**
 * Represents the StoreCustomCodeContent schema from Amazon Ads API v1.
 *
 * @generated from Amazon Ads API v1 schema StoreCustomCodeContent.
 */
final class StoreCustomCodeContent extends AbstractModel
{
    /**
     * The exact component schema name from the Amazon OpenAPI document.
     */
    public const OPENAPI_NAME = 'StoreCustomCodeContent';
     ...
     * Sets the cti value.
     *
     * @param CTI|array<string, mixed>|null $value New property value.
     * @return $this
     */
    public function setCti(CTI|array|null $value): self
    {
