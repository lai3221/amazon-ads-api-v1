...
/**
 * Represents the AdStateFilter schema from Amazon Ads API v1.
 *
 * @generated from Amazon Ads API v1 schema AdStateFilter.
 */
final class AdStateFilter extends AbstractModel
{
    /**
     * The exact component schema name from the Amazon OpenAPI document.
     */
    public const OPENAPI_NAME = 'AdStateFilter';
