...
/**
 * Represents the UpdateTargetingSettings schema from Amazon Ads API v1.
 *
 * @generated from Amazon Ads API v1 schema UpdateTargetingSettings.
 */
final class UpdateTargetingSettings extends AbstractModel
{
    /**
     * The exact component schema name from the Amazon OpenAPI document.
     */
    public const OPENAPI_NAME = 'UpdateTargetingSettings';
    ...
    protected const ATTRIBUTE_DEFINITIONS = [
        'amazonViewability' => [
            'type' => 'model',
            'class' => UpdateAmazonViewability::class,
            'required' => false,
            'nullable' => false,
        ],
     ...
     *
     * @return UpdateAmazonViewability|null
     */
    public function getAmazonViewability(): ?UpdateAmazonViewability
    {
        /** @var UpdateAmazonViewability|null $value */
     ...
     *
     * @param UpdateAmazonViewability|array<string, mixed>|null $value New property value.
     * @return $this
     */
    public function setAmazonViewability(UpdateAmazonViewability|array|null $value): self
    {
