 ...
 *
 * @generated from Amazon Ads API v1 schema CreateFoldPositionTarget.
 */
final class CreateFoldPositionTarget extends AbstractModel
{
    /**
     * The exact component schema name from the Amazon OpenAPI document.
     */
    public const OPENAPI_NAME = 'CreateFoldPositionTarget';
