 ...
 *
 * @generated from Amazon Ads API v1 schema CreateContentGenreTarget.
 */
final class CreateContentGenreTarget extends AbstractModel
{
    /**
     * The exact component schema name from the Amazon OpenAPI document.
     */
    public const OPENAPI_NAME = 'CreateContentGenreTarget';
