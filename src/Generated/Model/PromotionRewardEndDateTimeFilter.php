...
/**
 * Represents the PromotionRewardEndDateTimeFilter schema from Amazon Ads API v1.
 *
 * @generated from Amazon Ads API v1 schema PromotionRewardEndDateTimeFilter.
 */
final class PromotionRewardEndDateTimeFilter extends AbstractModel
{
    /**
     * The exact component schema name from the Amazon OpenAPI document.
     */
    public const OPENAPI_NAME = 'PromotionRewardEndDateTimeFilter';
