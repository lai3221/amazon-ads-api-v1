...
/**
 * Represents the CreateProductValue schema from Amazon Ads API v1.
 *
 * @generated from Amazon Ads API v1 schema CreateProductValue.
 */
final class CreateProductValue extends AbstractModel
{
    /**
     * The exact component schema name from the Amazon OpenAPI document.
     */
    public const OPENAPI_NAME = 'CreateProductValue';
    ...
    protected const ATTRIBUTE_DEFINITIONS = [
        'marketplaceSettings' => [
            ...
            'items' => [
                'type' => 'model',
                'class' => CreateProductMarketplaceSetting::class,
            ],
            'required' => false,
            'nullable' => false,
            'minItems' => 0,
     ...
     *
     * @return list<CreateProductMarketplaceSetting>|null
     */
    public function getMarketplaceSettings(): ?array
    {
        /** @var list<CreateProductMarketplaceSetting>|null $value */
     ...
     *
     * @param list<CreateProductMarketplaceSetting>|null $value New property value.
     * @return $this
     */
