...
/**
 * Represents the CreateAdGroupBudgetSettings schema from Amazon Ads API v1.
 *
 * @generated from Amazon Ads API v1 schema CreateAdGroupBudgetSettings.
 */
final class CreateAdGroupBudgetSettings extends AbstractModel
{
    /**
     * The exact component schema name from the Amazon OpenAPI document.
     */
    public const OPENAPI_NAME = 'CreateAdGroupBudgetSettings';
