...
/**
 * Represents the StoreMobileImageWithTextContent schema from Amazon Ads API v1.
 *
 * @generated from Amazon Ads API v1 schema StoreMobileImageWithTextContent.
 */
final class StoreMobileImageWithTextContent extends AbstractModel
{
    /**
     * The exact component schema name from the Amazon OpenAPI document.
     */
    public const OPENAPI_NAME = 'StoreMobileImageWithTextContent';
