...
/**
 * Represents the CreateStoreShoppablePoint schema from Amazon Ads API v1.
 *
 * @generated from Amazon Ads API v1 schema CreateStoreShoppablePoint.
 */
final class CreateStoreShoppablePoint extends AbstractModel
{
    /**
     * The exact component schema name from the Amazon OpenAPI document.
     */
    public const OPENAPI_NAME = 'CreateStoreShoppablePoint';
     ...
     *
     * @return CreateCoordinates|null
     */
    public function getCoordinates(): ?CreateCoordinates
    {
        /** @var CreateCoordinates|null $value */
     ...
     *
     * @param CreateCoordinates|array<string, mixed>|null $value New property value.
     * @return $this
     */
    public function setCoordinates(CreateCoordinates|array|null $value): self
    {
