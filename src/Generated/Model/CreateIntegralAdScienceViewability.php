 ...
 *
 * @generated from Amazon Ads API v1 schema CreateIntegralAdScienceViewability.
 */
final class CreateIntegralAdScienceViewability extends AbstractModel
{
    /**
     * The exact component schema name from the Amazon OpenAPI document.
     */
    public const OPENAPI_NAME = 'CreateIntegralAdScienceViewability';
