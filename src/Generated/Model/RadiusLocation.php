 ...
 *
 * @generated from Amazon Ads API v1 schema RadiusLocation.
 */
final class RadiusLocation extends AbstractModel
{
    /**
     * The exact component schema name from the Amazon OpenAPI document.
     */
    public const OPENAPI_NAME = 'RadiusLocation';
    ...
    protected const ATTRIBUTE_DEFINITIONS = [
        'coordinates' => [
            'type' => 'model',
            'class' => GeoLocationCoordinates::class,
            'required' => false,
            'nullable' => false,
        ],
     ...
     *
     * @return GeoLocationCoordinates|null
     */
    public function getCoordinates(): ?GeoLocationCoordinates
    {
        /** @var GeoLocationCoordinates|null $value */
     ...
     *
     * @param GeoLocationCoordinates|array<string, mixed>|null $value New property value.
     * @return $this
     */
    public function setCoordinates(GeoLocationCoordinates|array|null $value): self
    {
