 ...
 *
 * @generated from Amazon Ads API v1 schema DataProcessingOptions.
 */
final class DataProcessingOptions extends AbstractModel
{
    /**
     * The exact component schema name from the Amazon OpenAPI document.
     */
    public const OPENAPI_NAME = 'DataProcessingOptions';
