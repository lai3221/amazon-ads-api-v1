...
/**
 * Represents the DoubleVerifyAuthenticAttention schema from Amazon Ads API v1.
 *
 * @generated from Amazon Ads API v1 schema DoubleVerifyAuthenticAttention.
 */
final class DoubleVerifyAuthenticAttention extends AbstractModel
{
    /**
     * The exact component schema name from the Amazon OpenAPI document.
     */
    public const OPENAPI_NAME = 'DoubleVerifyAuthenticAttention';
