...
/**
 * Represents the LearnMoreVideoCallToActionSettings schema from Amazon Ads API v1.
 *
 * @generated from Amazon Ads API v1 schema LearnMoreVideoCallToActionSettings.
 */
final class LearnMoreVideoCallToActionSettings extends AbstractModel
{
    /**
     * The exact component schema name from the Amazon OpenAPI document.
     */
    public const OPENAPI_NAME = 'LearnMoreVideoCallToActionSettings';
