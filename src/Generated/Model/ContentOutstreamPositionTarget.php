 ...
 *
 * @generated from Amazon Ads API v1 schema ContentOutstreamPositionTarget.
 */
final class ContentOutstreamPositionTarget extends AbstractModel
{
    /**
     * The exact component schema name from the Amazon OpenAPI document.
     */
    public const OPENAPI_NAME = 'ContentOutstreamPositionTarget';
