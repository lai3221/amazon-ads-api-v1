...
/**
 * Represents the DoubleVerifyStandardDisplayBrandSafety schema from Amazon Ads API v1.
 *
 * @generated from Amazon Ads API v1 schema DoubleVerifyStandardDisplayBrandSafety.
 */
final class DoubleVerifyStandardDisplayBrandSafety extends AbstractModel
{
    /**
     * The exact component schema name from the Amazon OpenAPI document.
     */
    public const OPENAPI_NAME = 'DoubleVerifyStandardDisplayBrandSafety';
