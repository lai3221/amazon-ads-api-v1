...
/**
 * Represents the CreateAdGroupBidMarketplaceSetting schema from Amazon Ads API v1.
 *
 * @generated from Amazon Ads API v1 schema CreateAdGroupBidMarketplaceSetting.
 */
final class CreateAdGroupBidMarketplaceSetting extends AbstractModel
{
    /**
     * The exact component schema name from the Amazon OpenAPI document.
     */
    public const OPENAPI_NAME = 'CreateAdGroupBidMarketplaceSetting';
