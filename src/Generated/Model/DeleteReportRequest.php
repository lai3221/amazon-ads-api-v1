...
/**
 * Represents the DeleteReportRequest schema from Amazon Ads API v1.
 *
 * @generated from Amazon Ads API v1 schema DeleteReportRequest.
 */
final class DeleteReportRequest extends AbstractModel
{
    /**
     * The exact component schema name from the Amazon OpenAPI document.
     */
    public const OPENAPI_NAME = 'DeleteReportRequest';
