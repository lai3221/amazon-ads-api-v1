 ...
 *
 * @generated from Amazon Ads API v1 schema AssetBasedCreativeCallToActionSettings.
 */
final class AssetBasedCreativeCallToActionSettings extends AbstractModel
{
    /**
     * The exact component schema name from the Amazon OpenAPI document.
     */
    public const OPENAPI_NAME = 'AssetBasedCreativeCallToActionSettings';
