...
/**
 * Represents the StoreProductCollectionImageTile schema from Amazon Ads API v1.
 *
 * @generated from Amazon Ads API v1 schema StoreProductCollectionImageTile.
 */
final class StoreProductCollectionImageTile extends AbstractModel
{
    /**
     * The exact component schema name from the Amazon OpenAPI document.
     */
    public const OPENAPI_NAME = 'StoreProductCollectionImageTile';
