 ...
 *
 * @generated from Amazon Ads API v1 schema CreateAdPlayerSizeTarget.
 */
final class CreateAdPlayerSizeTarget extends AbstractModel
{
    /**
     * The exact component schema name from the Amazon OpenAPI document.
     */
    public const OPENAPI_NAME = 'CreateAdPlayerSizeTarget';
