...
/**
 * Represents the UpdateAdSettings schema from Amazon Ads API v1.
 *
 * @generated from Amazon Ads API v1 schema UpdateAdSettings.
 */
final class UpdateAdSettings extends AbstractModel
{
    /**
     * The exact component schema name from the Amazon OpenAPI document.
     */
    public const OPENAPI_NAME = 'UpdateAdSettings';
