...
/**
 * Represents the CreateAdGroupBid schema from Amazon Ads API v1.
 *
 * @generated from Amazon Ads API v1 schema CreateAdGroupBid.
 */
final class CreateAdGroupBid extends AbstractModel
{
    /**
     * The exact component schema name from the Amazon OpenAPI document.
     */
    public const OPENAPI_NAME = 'CreateAdGroupBid';
