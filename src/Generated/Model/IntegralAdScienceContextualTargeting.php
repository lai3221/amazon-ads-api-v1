...
/**
 * Represents the IntegralAdScienceContextualTargeting schema from Amazon Ads API v1.
 *
 * @generated from Amazon Ads API v1 schema IntegralAdScienceContextualTargeting.
 */
final class IntegralAdScienceContextualTargeting extends AbstractModel
{
    /**
     * The exact component schema name from the Amazon OpenAPI document.
     */
    public const OPENAPI_NAME = 'IntegralAdScienceContextualTargeting';
