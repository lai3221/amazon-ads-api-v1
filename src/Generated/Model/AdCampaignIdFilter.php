...
/**
 * Represents the AdCampaignIdFilter schema from Amazon Ads API v1.
 *
 * @generated from Amazon Ads API v1 schema AdCampaignIdFilter.
 */
final class AdCampaignIdFilter extends AbstractModel
{
    /**
     * The exact component schema name from the Amazon OpenAPI document.
     */
    public const OPENAPI_NAME = 'AdCampaignIdFilter';
