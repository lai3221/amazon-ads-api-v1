...
/**
 * Represents the CreateStoreProductWidget schema from Amazon Ads API v1.
 *
 * @generated from Amazon Ads API v1 schema CreateStoreProductWidget.
 */
final class CreateStoreProductWidget extends AbstractModel
{
    /**
     * The exact component schema name from the Amazon OpenAPI document.
     */
    public const OPENAPI_NAME = 'CreateStoreProductWidget';
    ...
    protected const ATTRIBUTE_DEFINITIONS = [
        ...
        'tiles' => [
            ...
            'items' => [
                'type' => 'model',
                'class' => CreateStoreProductTile::class,
            ],
            'required' => true,
            'nullable' => false,
            'minItems' => 1,
    ...
    /**
     * Returns The product tile configuration. Exactly one tile is required..
     *
     * @return list<CreateStoreProductTile>|null
     */
    public function getTiles(): ?array
    {
        /** @var list<CreateStoreProductTile>|null $value */
    ...
    /**
     * Sets The product tile configuration. Exactly one tile is required..
     *
     * @param list<CreateStoreProductTile>|null $value New property value.
     * @return $this
     */
