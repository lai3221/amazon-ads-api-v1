...
/**
 * Represents the AdGroupBudgetSettings schema from Amazon Ads API v1.
 *
 * @generated from Amazon Ads API v1 schema AdGroupBudgetSettings.
 */
final class AdGroupBudgetSettings extends AbstractModel
{
    /**
     * The exact component schema name from the Amazon OpenAPI document.
     */
    public const OPENAPI_NAME = 'AdGroupBudgetSettings';
