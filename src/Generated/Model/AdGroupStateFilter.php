...
/**
 * Represents the AdGroupStateFilter schema from Amazon Ads API v1.
 *
 * @generated from Amazon Ads API v1 schema AdGroupStateFilter.
 */
final class AdGroupStateFilter extends AbstractModel
{
    /**
     * The exact component schema name from the Amazon OpenAPI document.
     */
    public const OPENAPI_NAME = 'AdGroupStateFilter';
