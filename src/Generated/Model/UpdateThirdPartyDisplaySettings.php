...
/**
 * Represents the UpdateThirdPartyDisplaySettings schema from Amazon Ads API v1.
 *
 * @generated from Amazon Ads API v1 schema UpdateThirdPartyDisplaySettings.
 */
final class UpdateThirdPartyDisplaySettings extends AbstractModel
{
    /**
     * The exact component schema name from the Amazon OpenAPI document.
     */
    public const OPENAPI_NAME = 'UpdateThirdPartyDisplaySettings';
