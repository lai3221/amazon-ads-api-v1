...
/**
 * Represents the ThirdPartyDisplaySettings schema from Amazon Ads API v1.
 *
 * @generated from Amazon Ads API v1 schema ThirdPartyDisplaySettings.
 */
final class ThirdPartyDisplaySettings extends AbstractModel
{
    /**
     * The exact component schema name from the Amazon OpenAPI document.
     */
    public const OPENAPI_NAME = 'ThirdPartyDisplaySettings';
