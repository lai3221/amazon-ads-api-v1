...
/**
 * Represents the UpdateStandardDisplaySettings schema from Amazon Ads API v1.
 *
 * @generated from Amazon Ads API v1 schema UpdateStandardDisplaySettings.
 */
final class UpdateStandardDisplaySettings extends AbstractModel
{
    /**
     * The exact component schema name from the Amazon OpenAPI document.
     */
    public const OPENAPI_NAME = 'UpdateStandardDisplaySettings';
    ...
    protected const ATTRIBUTE_DEFINITIONS = [
        ...
        'callToAction' => [
            'type' => 'model',
            'class' => UpdateDisplayCallToAction::class,
            'required' => false,
            'nullable' => false,
        ],
        'clickTrackingUrls' => [
     ...
     *
     * @return UpdateDisplayCallToAction|null
     */
    public function getCallToAction(): ?UpdateDisplayCallToAction
    {
        /** @var UpdateDisplayCallToAction|null $value */
     ...
     *
     * @param UpdateDisplayCallToAction|array<string, mixed>|null $value New property value.
     * @return $this
     */
    public function setCallToAction(UpdateDisplayCallToAction|array|null $value): self
    {
