...
/**
 * Represents the CampaignPortfolioIdFilter schema from Amazon Ads API v1.
 *
 * @generated from Amazon Ads API v1 schema CampaignPortfolioIdFilter.
 */
final class CampaignPortfolioIdFilter extends AbstractModel
{
    /**
     * The exact component schema name from the Amazon OpenAPI document.
     */
    public const OPENAPI_NAME = 'CampaignPortfolioIdFilter';
