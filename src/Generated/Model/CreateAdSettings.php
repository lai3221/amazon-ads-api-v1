...
/**
 * Represents the CreateAdSettings schema from Amazon Ads API v1.
 *
 * @generated from Amazon Ads API v1 schema CreateAdSettings.
 */
final class CreateAdSettings extends AbstractModel
{
    /**
     * The exact component schema name from the Amazon OpenAPI document.
     */
    public const OPENAPI_NAME = 'CreateAdSettings';
