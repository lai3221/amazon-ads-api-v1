...
/**
 * Represents the ForbiddenResponseContent schema from Amazon Ads API v1.
 *
 * @generated from Amazon Ads API v1 schema ForbiddenResponseContent.
 */
final class ForbiddenResponseContent extends AbstractModel
{
    /**
     * The exact component schema name from the Amazon OpenAPI document.
     */
    public const OPENAPI_NAME = 'ForbiddenResponseContent';
