 ...
 *
 * @generated from Amazon Ads API v1 schema CreateStoreProductSelectorQuestion.
 */
final class CreateStoreProductSelectorQuestion extends AbstractModel
{
    /**
     * The exact component schema name from the Amazon OpenAPI document.
     */
    public const OPENAPI_NAME = 'CreateStoreProductSelectorQuestion';
    ...
    protected const ATTRIBUTE_DEFINITIONS = [
        'answerList' => [
            ...
            'items' => [
                'type' => 'model',
                'class' => CreateStoreProductSelectorAnswer::class,
            ],
            'required' => false,
            'nullable' => false,
            'minItems' => 0,
     ...
     *
     * @return list<CreateStoreProductSelectorAnswer>|null
     */
    public function getAnswerList(): ?array
    {
        /** @var list<CreateStoreProductSelectorAnswer>|null $value */
     ...
     *
     * @param list<CreateStoreProductSelectorAnswer>|null $value New property value.
     * @return $this
     */
