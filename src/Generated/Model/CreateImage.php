...
/**
 * Represents the CreateImage schema from Amazon Ads API v1.
 *
 * @generated from Amazon Ads API v1 schema CreateImage.
 */
final class CreateImage extends AbstractModel
{
    /**
     * The exact component schema name from the Amazon OpenAPI document.
     */
    public const OPENAPI_NAME = 'CreateImage';
