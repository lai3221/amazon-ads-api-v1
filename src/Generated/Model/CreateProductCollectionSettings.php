 ...
 *
 * @generated from Amazon Ads API v1 schema CreateProductCollectionSettings.
 */
final class CreateProductCollectionSettings extends AbstractModel
{
    /**
     * The exact component schema name from the Amazon OpenAPI document.
     */
    public const OPENAPI_NAME = 'CreateProductCollectionSettings';
    ...
    protected const ATTRIBUTE_DEFINITIONS = [
        ...
        'landingPage' => [
            'type' => 'model',
            'class' => CreateProductCollectionLandingPage::class,
            'required' => true,
            'nullable' => false,
        ],
        'products' => [
     ...
     *
     * @return CreateProductCollectionLandingPage|null
     */
    public function getLandingPage(): ?CreateProductCollectionLandingPage
    {
        /** @var CreateProductCollectionLandingPage|null $value */
     ...
     *
     * @param CreateProductCollectionLandingPage|array<string, mixed>|null $value New property value.
     * @return $this
     */
    public function setLandingPage(CreateProductCollectionLandingPage|array|null $value): self
    {
