...
/**
 * Represents the AdvertiserAccountCreate schema from Amazon Ads API v1.
 *
 * @generated from Amazon Ads API v1 schema AdvertiserAccountCreate.
 */
final class AdvertiserAccountCreate extends AbstractModel
{
    /**
     * The exact component schema name from the Amazon OpenAPI document.
     */
    public const OPENAPI_NAME = 'AdvertiserAccountCreate';
