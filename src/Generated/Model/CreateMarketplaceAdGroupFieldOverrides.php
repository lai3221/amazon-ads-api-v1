...
/**
 * Represents the CreateMarketplaceAdGroupFieldOverrides schema from Amazon Ads API v1.
 *
 * @generated from Amazon Ads API v1 schema CreateMarketplaceAdGroupFieldOverrides.
 */
final class CreateMarketplaceAdGroupFieldOverrides extends AbstractModel
{
    /**
     * The exact component schema name from the Amazon OpenAPI document.
     */
    public const OPENAPI_NAME = 'CreateMarketplaceAdGroupFieldOverrides';
