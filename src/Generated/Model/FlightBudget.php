...
/**
 * Represents the FlightBudget schema from Amazon Ads API v1.
 *
 * @generated from Amazon Ads API v1 schema FlightBudget.
 */
final class FlightBudget extends AbstractModel
{
    /**
     * The exact component schema name from the Amazon OpenAPI document.
     */
    public const OPENAPI_NAME = 'FlightBudget';
     ...
     *
     * @return BudgetValue|null
     */
    public function getBudgetValue(): ?BudgetValue
    {
        /** @var BudgetValue|null $value */
     ...
     *
     * @param BudgetValue|array<string, mixed>|null $value New property value.
     * @return $this
     */
    public function setBudgetValue(BudgetValue|array|null $value): self
    {
