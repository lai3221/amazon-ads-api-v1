...
/**
 * Represents the RuleTagsFilter schema from Amazon Ads API v1.
 *
 * @generated from Amazon Ads API v1 schema RuleTagsFilter.
 */
final class RuleTagsFilter extends AbstractModel
{
    /**
     * The exact component schema name from the Amazon OpenAPI document.
     */
    public const OPENAPI_NAME = 'RuleTagsFilter';
