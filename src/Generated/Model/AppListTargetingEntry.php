...
/**
 * An app list targeting entry. All entries must share the same negative value.
 *
 * @generated from Amazon Ads API v1 schema AppListTargetingEntry.
 */
final class AppListTargetingEntry extends AbstractModel
{
    /**
     * The exact component schema name from the Amazon OpenAPI document.
     */
    public const OPENAPI_NAME = 'AppListTargetingEntry';
    ...
    /**
     * Returns The app list to target..
     *
     * @return string|null
     */
    public function getAppListId(): ?string
    {
        /** @var string|null $value */
        $value = $this->getAttribute('appListId');

        return $value;
    }

    /**
     * Sets The app list to target..
     *
     * @param string|null $value New property value.
     * @return $this
     */
    public function setAppListId(?string $value): self
    {
        $this->setAttribute('appListId', $value);
