...
/**
 * Represents the ComponentLandingPage schema from Amazon Ads API v1.
 *
 * @generated from Amazon Ads API v1 schema ComponentLandingPage.
 */
final class ComponentLandingPage extends AbstractModel
{
    /**
     * The exact component schema name from the Amazon OpenAPI document.
     */
    public const OPENAPI_NAME = 'ComponentLandingPage';
