...
/**
 * Represents the StoreCarouselContent schema from Amazon Ads API v1.
 *
 * @generated from Amazon Ads API v1 schema StoreCarouselContent.
 */
final class StoreCarouselContent extends AbstractModel
{
    /**
     * The exact component schema name from the Amazon OpenAPI document.
     */
    public const OPENAPI_NAME = 'StoreCarouselContent';
    ...
    protected const ATTRIBUTE_DEFINITIONS = [
        ...
        'search' => [
            'type' => 'model',
            'class' => StoreCarouselSearch::class,
            'required' => false,
            'nullable' => false,
        ],
        'slides' => [
     ...
     *
     * @return StoreCarouselSearch|null
     */
    public function getSearch(): ?StoreCarouselSearch
    {
        /** @var StoreCarouselSearch|null $value */
     ...
     *
     * @param StoreCarouselSearch|array<string, mixed>|null $value New property value.
     * @return $this
     */
    public function setSearch(StoreCarouselSearch|array|null $value): self
    {
     ...
     *
     * @return list<StoreASINSlide>|null
     */
    public function getSlides(): ?array
    {
        /** @var list<StoreASINSlide>|null $value */
     ...
     *
     * @param list<StoreASINSlide>|null $value New property value.
     * @return $this
     */
