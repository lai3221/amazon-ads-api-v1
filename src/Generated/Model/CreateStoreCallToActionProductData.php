...
/**
 * Represents the CreateStoreCallToActionProductData schema from Amazon Ads API v1.
 *
 * @generated from Amazon Ads API v1 schema CreateStoreCallToActionProductData.
 */
final class CreateStoreCallToActionProductData extends AbstractModel
{
    /**
     * The exact component schema name from the Amazon OpenAPI document.
     */
    public const OPENAPI_NAME = 'CreateStoreCallToActionProductData';
