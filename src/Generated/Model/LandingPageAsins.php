...
/**
 * Represents the LandingPageAsins schema from Amazon Ads API v1.
 *
 * @generated from Amazon Ads API v1 schema LandingPageAsins.
 */
final class LandingPageAsins extends AbstractModel
{
    /**
     * The exact component schema name from the Amazon OpenAPI document.
     */
    public const OPENAPI_NAME = 'LandingPageAsins';
