...
/**
 * Represents the UpdateDirectIndexValues schema from Amazon Ads API v1.
 *
 * @generated from Amazon Ads API v1 schema UpdateDirectIndexValues.
 */
final class UpdateDirectIndexValues extends AbstractModel
{
    /**
     * The exact component schema name from the Amazon OpenAPI document.
     */
    public const OPENAPI_NAME = 'UpdateDirectIndexValues';
