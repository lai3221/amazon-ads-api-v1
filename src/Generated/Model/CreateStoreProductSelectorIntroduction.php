 ...
 *
 * @generated from Amazon Ads API v1 schema CreateStoreProductSelectorIntroduction.
 */
final class CreateStoreProductSelectorIntroduction extends AbstractModel
{
    /**
     * The exact component schema name from the Amazon OpenAPI document.
     */
    public const OPENAPI_NAME = 'CreateStoreProductSelectorIntroduction';
    ...
    protected const ATTRIBUTE_DEFINITIONS = [
        ...
        'imageOptions' => [
            'type' => 'model',
            'class' => CreateStoreProductSelectorImageOptions::class,
            'required' => true,
            'nullable' => false,
        ],
        'isEnabled' => [
     ...
     *
     * @return CreateStoreProductSelectorImageOptions|null
     */
    public function getImageOptions(): ?CreateStoreProductSelectorImageOptions
    {
        /** @var CreateStoreProductSelectorImageOptions|null $value */
     ...
     *
     * @param CreateStoreProductSelectorImageOptions|array<string, mixed>|null $value New property value.
     * @return $this
     */
    public function setImageOptions(CreateStoreProductSelectorImageOptions|array|null $value): self
    {
