...
/**
 * Represents the CreateStoreMobileContent schema from Amazon Ads API v1.
 *
 * @generated from Amazon Ads API v1 schema CreateStoreMobileContent.
 */
final class CreateStoreMobileContent extends AbstractModel
{
    /**
     * The exact component schema name from the Amazon OpenAPI document.
     */
    public const OPENAPI_NAME = 'CreateStoreMobileContent';
