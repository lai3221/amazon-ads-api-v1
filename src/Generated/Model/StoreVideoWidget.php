...
/**
 * Represents the StoreVideoWidget schema from Amazon Ads API v1.
 *
 * @generated from Amazon Ads API v1 schema StoreVideoWidget.
 */
final class StoreVideoWidget extends AbstractModel
{
    /**
     * The exact component schema name from the Amazon OpenAPI document.
     */
    public const OPENAPI_NAME = 'StoreVideoWidget';
     ...
     *
     * @return list<StoreVideoTile>|null
     */
    public function getTiles(): ?array
    {
        /** @var list<StoreVideoTile>|null $value */
     ...
     *
     * @param list<StoreVideoTile>|null $value New property value.
     * @return $this
     */
