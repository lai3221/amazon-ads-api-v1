...
/**
 * Represents the CreatePlacementBidAdjustment schema from Amazon Ads API v1.
 *
 * @generated from Amazon Ads API v1 schema CreatePlacementBidAdjustment.
 */
final class CreatePlacementBidAdjustment extends AbstractModel
{
    /**
     * The exact component schema name from the Amazon OpenAPI document.
     */
    public const OPENAPI_NAME = 'CreatePlacementBidAdjustment';
