...
/**
 * Represents the CreateStoreGallerySlide schema from Amazon Ads API v1.
 *
 * @generated from Amazon Ads API v1 schema CreateStoreGallerySlide.
 */
final class CreateStoreGallerySlide extends AbstractModel
{
    /**
     * The exact component schema name from the Amazon OpenAPI document.
     */
    public const OPENAPI_NAME = 'CreateStoreGallerySlide';
