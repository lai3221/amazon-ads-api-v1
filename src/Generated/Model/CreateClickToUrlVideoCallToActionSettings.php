...
/**
 * Represents the CreateClickToUrlVideoCallToActionSettings schema from Amazon Ads API v1.
 *
 * @generated from Amazon Ads API v1 schema CreateClickToUrlVideoCallToActionSettings.
 */
final class CreateClickToUrlVideoCallToActionSettings extends AbstractModel
{
    /**
     * The exact component schema name from the Amazon OpenAPI document.
     */
    public const OPENAPI_NAME = 'CreateClickToUrlVideoCallToActionSettings';
    ...
    /**
     * Returns The url to redirect the user via the video CallToAction..
     *
     * @return string|null
     */
    ...
    /**
     * Sets The url to redirect the user via the video CallToAction..
     *
