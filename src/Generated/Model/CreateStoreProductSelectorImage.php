 ...
 *
 * @generated from Amazon Ads API v1 schema CreateStoreProductSelectorImage.
 */
final class CreateStoreProductSelectorImage extends AbstractModel
{
    /**
     * The exact component schema name from the Amazon OpenAPI document.
     */
    public const OPENAPI_NAME = 'CreateStoreProductSelectorImage';
