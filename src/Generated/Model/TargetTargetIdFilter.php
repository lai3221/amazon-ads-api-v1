...
/**
 * Represents the TargetTargetIdFilter schema from Amazon Ads API v1.
 *
 * @generated from Amazon Ads API v1 schema TargetTargetIdFilter.
 */
final class TargetTargetIdFilter extends AbstractModel
{
    /**
     * The exact component schema name from the Amazon OpenAPI document.
     */
    public const OPENAPI_NAME = 'TargetTargetIdFilter';
