...
/**
 * Represents the CreateAudienceBidAdjustment schema from Amazon Ads API v1.
 *
 * @generated from Amazon Ads API v1 schema CreateAudienceBidAdjustment.
 */
final class CreateAudienceBidAdjustment extends AbstractModel
{
    /**
     * The exact component schema name from the Amazon OpenAPI document.
     */
    public const OPENAPI_NAME = 'CreateAudienceBidAdjustment';
