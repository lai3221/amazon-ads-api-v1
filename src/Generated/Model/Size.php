...
/**
 * Represents the Size schema from Amazon Ads API v1.
 *
 * @generated from Amazon Ads API v1 schema Size.
 */
final class Size extends AbstractModel
{
    /**
     * The exact component schema name from the Amazon OpenAPI document.
     */
    public const OPENAPI_NAME = 'Size';
