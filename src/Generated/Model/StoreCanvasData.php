...
/**
 * Represents the StoreCanvasData schema from Amazon Ads API v1.
 *
 * @generated from Amazon Ads API v1 schema StoreCanvasData.
 */
final class StoreCanvasData extends AbstractModel
{
    /**
     * The exact component schema name from the Amazon OpenAPI document.
     */
    public const OPENAPI_NAME = 'StoreCanvasData';
