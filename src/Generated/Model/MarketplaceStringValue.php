...
/**
 * Represents the MarketplaceStringValue schema from Amazon Ads API v1.
 *
 * @generated from Amazon Ads API v1 schema MarketplaceStringValue.
 */
final class MarketplaceStringValue extends AbstractModel
{
    /**
     * The exact component schema name from the Amazon OpenAPI document.
     */
    public const OPENAPI_NAME = 'MarketplaceStringValue';
