...
/**
 * Represents the CreateStoreASINSlide schema from Amazon Ads API v1.
 *
 * @generated from Amazon Ads API v1 schema CreateStoreASINSlide.
 */
final class CreateStoreASINSlide extends AbstractModel
{
    /**
     * The exact component schema name from the Amazon OpenAPI document.
     */
    public const OPENAPI_NAME = 'CreateStoreASINSlide';
