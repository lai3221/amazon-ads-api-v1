 ...
 *
 * @generated from Amazon Ads API v1 schema CreateBrandedRecipeQuantityItem.
 */
final class CreateBrandedRecipeQuantityItem extends AbstractModel
{
    /**
     * The exact component schema name from the Amazon OpenAPI document.
     */
    public const OPENAPI_NAME = 'CreateBrandedRecipeQuantityItem';
