...
/**
 * Represents the CreateStoreMetadataItem schema from Amazon Ads API v1.
 *
 * @generated from Amazon Ads API v1 schema CreateStoreMetadataItem.
 */
final class CreateStoreMetadataItem extends AbstractModel
{
    /**
     * The exact component schema name from the Amazon OpenAPI document.
     */
    public const OPENAPI_NAME = 'CreateStoreMetadataItem';
