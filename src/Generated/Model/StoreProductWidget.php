...
/**
 * Represents the StoreProductWidget schema from Amazon Ads API v1.
 *
 * @generated from Amazon Ads API v1 schema StoreProductWidget.
 */
final class StoreProductWidget extends AbstractModel
{
    /**
     * The exact component schema name from the Amazon OpenAPI document.
     */
    public const OPENAPI_NAME = 'StoreProductWidget';
     ...
     *
     * @return list<StoreProductTile>|null
     */
    public function getTiles(): ?array
    {
        /** @var list<StoreProductTile>|null $value */
     ...
     *
     * @param list<StoreProductTile>|null $value New property value.
     * @return $this
     */
