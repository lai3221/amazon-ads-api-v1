...
/**
 * Represents the RuleCreate schema from Amazon Ads API v1.
 *
 * @generated from Amazon Ads API v1 schema RuleCreate.
 */
final class RuleCreate extends AbstractModel
{
    /**
     * The exact component schema name from the Amazon OpenAPI document.
     */
    public const OPENAPI_NAME = 'RuleCreate';
    ...
    protected const ATTRIBUTE_DEFINITIONS = [
        ...
        'duration' => [
            'type' => 'model',
            'class' => CreateRuleDuration::class,
            'required' => false,
            'nullable' => false,
        ],
        'expression' => [
     ...
     *
     * @return CreateRuleDuration|null
     */
    public function getDuration(): ?CreateRuleDuration
    {
        /** @var CreateRuleDuration|null $value */
     ...
     *
     * @param CreateRuleDuration|array<string, mixed>|null $value New property value.
     * @return $this
     */
    public function setDuration(CreateRuleDuration|array|null $value): self
    {
