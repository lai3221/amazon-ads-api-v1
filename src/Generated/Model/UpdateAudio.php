...
/**
 * Represents the UpdateAudio schema from Amazon Ads API v1.
 *
 * @generated from Amazon Ads API v1 schema UpdateAudio.
 */
final class UpdateAudio extends AbstractModel
{
    /**
     * The exact component schema name from the Amazon OpenAPI document.
     */
    public const OPENAPI_NAME = 'UpdateAudio';
