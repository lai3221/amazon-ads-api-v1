...
/**
 * Represents the UpdateGlobalStoreSettings schema from Amazon Ads API v1.
 *
 * @generated from Amazon Ads API v1 schema UpdateGlobalStoreSettings.
 */
final class UpdateGlobalStoreSettings extends AbstractModel
{
    /**
     * The exact component schema name from the Amazon OpenAPI document.
     */
    public const OPENAPI_NAME = 'UpdateGlobalStoreSettings';
