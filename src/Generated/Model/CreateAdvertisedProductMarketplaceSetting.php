...
/**
 * Represents the CreateAdvertisedProductMarketplaceSetting schema from Amazon Ads API v1.
 *
 * @generated from Amazon Ads API v1 schema CreateAdvertisedProductMarketplaceSetting.
 */
final class CreateAdvertisedProductMarketplaceSetting extends AbstractModel
{
    /**
     * The exact component schema name from the Amazon OpenAPI document.
     */
    public const OPENAPI_NAME = 'CreateAdvertisedProductMarketplaceSetting';
    ...
    protected const ATTRIBUTE_DEFINITIONS = [
        'globalStoreSetting' => [
            'type' => 'model',
            'class' => CreateGlobalStoreSettings::class,
            'required' => false,
            'nullable' => false,
        ],
        'marketplace' => [
     ...
     *
     * @return CreateGlobalStoreSettings|null
     */
    public function getGlobalStoreSetting(): ?CreateGlobalStoreSettings
    {
        /** @var CreateGlobalStoreSettings|null $value */
     ...
     *
     * @param CreateGlobalStoreSettings|array<string, mixed>|null $value New property value.
     * @return $this
     */
    public function setGlobalStoreSetting(CreateGlobalStoreSettings|array|null $value): self
    {
