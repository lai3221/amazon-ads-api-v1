...
use Lai3221\AmazonAdsApiV1\Generated\Model\LinearTvDaypartSuccessResponse;
use Lai3221\AmazonAdsApiV1\Generated\Model\NotFoundResponseContent;
use Lai3221\AmazonAdsApiV1\Generated\Model\QueryLinearTvDaypartRequest;
...
/**
 * Provides all LinearTvDayparts operations from the Amazon Ads API v1 full specification.
 *
 * @generated from Amazon Ads API v1 tag LinearTvDayparts.
 */
final class LinearTvDaypartsApi extends AbstractApi
{
    /**
     * List all supported Linear TV Daypart.
     *
     * Required OpenAPI headers: Amazon-Ads-ClientId.
     * Declared OAuth scopes: advertising::campaign_management.
     *
     * @param QueryLinearTvDaypartRequest|array<string, mixed>|null $request Optional operation request body.
     * @param RequestContext|null $context Optional per-request account and profile headers.
     * @return ApiResponse<LinearTvDaypartSuccessResponse> Hydrated successful response.
     */
    public function queryLinearTvDaypart(
        QueryLinearTvDaypartRequest|array|null $request = null,
        ?RequestContext $context = null,
    ): ApiResponse {
        return $this->transport->request(
            method: 'POST',
            path: '/adsApi/v1/query/linearTvDayparts',
            query: [],
            body: $request,
            context: $context,
            requiredHeaders: [
            ...
            responseTypes: [
                '200' => LinearTvDaypartSuccessResponse::class,
