...
use Lai3221\AmazonAdsApiV1\Generated\Model\PublisherSuccessResponse;
use Lai3221\AmazonAdsApiV1\Generated\Model\QueryPublisherRequest;
...
/**
 * Provides all Publishers operations from the Amazon Ads API v1 full specification.
 *
 * @generated from Amazon Ads API v1 tag Publishers.
 */
final class PublishersApi extends AbstractApi
{
    /**
     * List all Publishers.
     *
     ...
     *
     * @param QueryPublisherRequest|array<string, mixed>|null $request Optional operation request body.
     * @param RequestContext|null $context Optional per-request account and profile headers.
     * @return ApiResponse<PublisherSuccessResponse> Hydrated successful response.
     */
    public function queryPublisher(
        QueryPublisherRequest|array|null $request = null,
        ?RequestContext $context = null,
    ): ApiResponse {
        return $this->transport->request(
            method: 'POST',
            path: '/adsApi/v1/query/publishers',
            query: [],
            body: $request,
            context: $context,
            requiredHeaders: [
            ...
            responseTypes: [
                '200' => PublisherSuccessResponse::class,
