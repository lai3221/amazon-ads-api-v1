...
use Lai3221\AmazonAdsApiV1\Generated\Model\DealAvailsSuccessResponse;
...
use Lai3221\AmazonAdsApiV1\Generated\Model\QueryDealAvailsRequest;
...
/**
 * Provides all DealAvailses operations from the Amazon Ads API v1 full specification.
 *
 * @generated from Amazon Ads API v1 tag DealAvailses.
 */
final class DealAvailsesApi extends AbstractApi
{
    /**
     ...
     *
     * @param QueryDealAvailsRequest|array<string, mixed> $request Operation request body.
     * @param RequestContext|null $context Optional per-request account and profile headers.
     * @return ApiResponse<DealAvailsSuccessResponse> Hydrated successful response.
     */
    public function queryDealAvails(
        QueryDealAvailsRequest|array $request,
        ?RequestContext $context = null,
    ): ApiResponse {
        return $this->transport->request(
            method: 'POST',
            path: '/adsApi/v1/query/dealAvailses',
            query: [],
            body: $request,
            context: $context,
            requiredHeaders: [
            ...
            responseTypes: [
                '200' => DealAvailsSuccessResponse::class,
