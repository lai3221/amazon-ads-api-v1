...
use Lai3221\AmazonAdsApiV1\Generated\Model\QuerySellerRequest;
use Lai3221\AmazonAdsApiV1\Generated\Model\SellerSuccessResponse;
...
/**
 * Provides all Sellers operations from the Amazon Ads API v1 full specification.
 *
 * @generated from Amazon Ads API v1 tag Sellers.
 */
final class SellersApi extends AbstractApi
{
    /**
     * Query sellers. A seller is a business entity that has the rights to sell a publisher's advertising inventory and holds accounts with suppliers that send that inventory to Amazon DSP. Use this API to search sellers by ID or name, for example to identify a se.
     *
     * Required OpenAPI headers: Amazon-Ads-ClientId.
     * Declared OAuth scopes: advertising::campaign_management.
     *
     * @param QuerySellerRequest|array<string, mixed>|null $request Optional operation request body.
     * @param RequestContext|null $context Optional per-request account and profile headers.
     * @return ApiResponse<SellerSuccessResponse> Hydrated successful response.
     */
    public function querySeller(
        QuerySellerRequest|array|null $request = null,
        ?RequestContext $context = null,
    ): ApiResponse {
        return $this->transport->request(
            method: 'POST',
            path: '/adsApi/v1/query/sellers',
            query: [],
            body: $request,
            context: $context,
            requiredHeaders: [
            ...
            responseTypes: [
                '200' => SellerSuccessResponse::class,
