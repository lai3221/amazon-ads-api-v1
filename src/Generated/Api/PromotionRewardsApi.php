...
use Lai3221\AmazonAdsApiV1\Generated\Model\PromotionRewardSuccessResponse;
use Lai3221\AmazonAdsApiV1\Generated\Model\QueryPromotionRewardRequest;
...
/**
 * Provides all PromotionRewards operations from the Amazon Ads API v1 full specification.
 *
 * @generated from Amazon Ads API v1 tag PromotionRewards.
 */
final class PromotionRewardsApi extends AbstractApi
{
    /**
     * Query promotion rewards for an advertiser account. Returns reward details including type, amounts, consumption tracking, and linked account information.
     *
     * Required OpenAPI headers: Amazon-Ads-AccountId, Amazon-Ads-ClientId.
     * Declared OAuth scopes: advertising::campaign_management.
     *
     * @param QueryPromotionRewardRequest|array<string, mixed>|null $request Optional operation request body.
     * @param RequestContext|null $context Optional per-request account and profile headers.
     * @return ApiResponse<PromotionRewardSuccessResponse> Hydrated successful response.
     */
    public function queryPromotionReward(
        QueryPromotionRewardRequest|array|null $request = null,
        ?RequestContext $context = null,
    ): ApiResponse {
        return $this->transport->request(
            method: 'POST',
            path: '/adsApi/v1/query/promotionRewards',
            query: [],
            body: $request,
            context: $context,
            requiredHeaders: [
            ...
            responseTypes: [
                '200' => PromotionRewardSuccessResponse::class,
