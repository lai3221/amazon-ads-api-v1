...
use Lai3221\AmazonAdsApiV1\Generated\Model\CreateEventRequest;
use Lai3221\AmazonAdsApiV1\Generated\Model\EventMultiStatusResponse;
...
/**
 * Provides all Events operations from the Amazon Ads API v1 full specification.
 *
 * @generated from Amazon Ads API v1 tag Events.
 */
final class EventsApi extends AbstractApi
{
    /**
     * Create Event Data.
     *
     ...
     *
     * @param CreateEventRequest|array<string, mixed> $request Operation request body.
     * @param RequestContext|null $context Optional per-request account and profile headers.
     * @return ApiResponse<EventMultiStatusResponse> Hydrated successful response.
     */
    public function createEvent(
        CreateEventRequest|array $request,
        ?RequestContext $context = null,
    ): ApiResponse {
        return $this->transport->request(
            method: 'POST',
            path: '/adsApi/v1/create/events',
            query: [],
            body: $request,
            context: $context,
            requiredHeaders: [
            ...
            responseTypes: [
                '207' => EventMultiStatusResponse::class,
